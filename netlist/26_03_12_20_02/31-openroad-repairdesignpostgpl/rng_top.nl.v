module rng_top (clk_i,
 ...
 sky130_fd_sc_hd__inv_2 _126_ (.A(net7),
    .Y(_000_));
 sky130_fd_sc_hd__and2b_1 _127_ (.A_N(\rng_rd.wr_ff2_d ),
    .B(\rng_rd.wr_ff2 ),
    .X(_001_));
 ...
 sky130_fd_sc_hd__mux2_1 _149_ (.A0(net4),
    ...
    .S(net9),
    .X(_023_));
 sky130_fd_sc_hd__mux2_1 _150_ (.A0(net5),
    .A1(net11),
    .S(net7),
    .X(_024_));
 ...
 sky130_fd_sc_hd__nor2_1 _157_ (.A(_048_),
    .B(_049_),
    .Y(_027_));
 sky130_fd_sc_hd__xor2_1 _158_ (.A(\num_i_bar[2] ),
    .B(_048_),
    .X(_028_));
 ...
 sky130_fd_sc_hd__mux2_1 _161_ (.A0(\rng_rd.ram_6[2] ),
    ...
    .S(net8),
    .X(_031_));
 sky130_fd_sc_hd__dfrtp_1 _162_ (.CLK(clk_i),
    .D(_002_),
    .RESET_B(net15),
    .Q(\rng_rd.cache[0] ));
 sky130_fd_sc_hd__dfrtp_1 _163_ (.CLK(clk_i),
    .D(_003_),
    .RESET_B(net15),
    .Q(\rng_rd.cache[1] ));
 sky130_fd_sc_hd__dfrtp_2 _164_ (.CLK(clk_i),
    ...
    .RESET_B(net15),
    .Q(\rng_rd.cache[2] ));
 sky130_fd_sc_hd__dfrtp_1 _165_ (.CLK(clk_i),
    .D(_005_),
    .RESET_B(net15),
    .Q(\rng_rd.ram_7[0] ));
 sky130_fd_sc_hd__dfrtp_1 _166_ (.CLK(clk_i),
    .D(_006_),
    .RESET_B(net16),
    .Q(\rng_rd.ram_7[1] ));
 sky130_fd_sc_hd__dfrtp_1 _167_ (.CLK(clk_i),
    .D(_007_),
    .RESET_B(net16),
    .Q(\rng_rd.ram_7[2] ));
 sky130_fd_sc_hd__dfrtp_1 _168_ (.CLK(clk_i),
    .D(_008_),
    .RESET_B(net15),
    .Q(\rng_rd.ram_5[0] ));
 sky130_fd_sc_hd__dfrtp_1 _169_ (.CLK(clk_i),
    .D(_009_),
    .RESET_B(net14),
    .Q(\rng_rd.ram_5[1] ));
 sky130_fd_sc_hd__dfrtp_1 _170_ (.CLK(clk_i),
    .D(_010_),
    .RESET_B(net14),
    .Q(\rng_rd.ram_5[2] ));
 sky130_fd_sc_hd__dfrtp_1 _171_ (.CLK(clk_i),
    .D(net3),
    .RESET_B(net15),
    .Q(\rng_rd.wr_ff1 ));
 sky130_fd_sc_hd__dfrtp_1 _172_ (.CLK(clk_i),
    .D(_011_),
    .RESET_B(net13),
    .Q(\rng_rd.ram_4[0] ));
 sky130_fd_sc_hd__dfrtp_1 _173_ (.CLK(clk_i),
    .D(_012_),
    .RESET_B(net14),
    .Q(\rng_rd.ram_4[1] ));
 sky130_fd_sc_hd__dfrtp_1 _174_ (.CLK(clk_i),
    .D(_013_),
    .RESET_B(net14),
    .Q(\rng_rd.ram_4[2] ));
 sky130_fd_sc_hd__dfrtp_1 _175_ (.CLK(clk_i),
    .D(_014_),
    .RESET_B(net13),
    .Q(\rng_rd.ram_3[0] ));
 sky130_fd_sc_hd__dfrtp_1 _176_ (.CLK(clk_i),
    .D(_015_),
    .RESET_B(net14),
    .Q(\rng_rd.ram_3[1] ));
 sky130_fd_sc_hd__dfrtp_1 _177_ (.CLK(clk_i),
    .D(_016_),
    .RESET_B(net14),
    .Q(\rng_rd.ram_3[2] ));
 sky130_fd_sc_hd__dfrtp_1 _178_ (.CLK(clk_i),
    .D(_017_),
    .RESET_B(net13),
    .Q(\rng_rd.ram_2[0] ));
 sky130_fd_sc_hd__dfrtp_1 _179_ (.CLK(clk_i),
    .D(_018_),
    .RESET_B(net13),
    .Q(\rng_rd.ram_2[1] ));
 sky130_fd_sc_hd__dfrtp_1 _180_ (.CLK(clk_i),
    .D(_019_),
    .RESET_B(net13),
    .Q(\rng_rd.ram_2[2] ));
 sky130_fd_sc_hd__dfrtp_1 _181_ (.CLK(clk_i),
    .D(\rng_rd.wr_ff1 ),
    .RESET_B(net15),
    .Q(\rng_rd.wr_ff2 ));
 sky130_fd_sc_hd__dfrtp_1 _182_ (.CLK(clk_i),
    .D(_020_),
    .RESET_B(net13),
    .Q(\rng_rd.ram_1[0] ));
 sky130_fd_sc_hd__dfrtp_1 _183_ (.CLK(clk_i),
    .D(_021_),
    .RESET_B(net13),
    .Q(\rng_rd.ram_1[1] ));
 sky130_fd_sc_hd__dfrtp_1 _184_ (.CLK(clk_i),
    .D(_022_),
    .RESET_B(net13),
    .Q(\rng_rd.ram_1[2] ));
 sky130_fd_sc_hd__dfrtp_1 _185_ (.CLK(clk_i),
    .D(_023_),
    .RESET_B(net14),
    .Q(net4));
 sky130_fd_sc_hd__dfrtp_1 _186_ (.CLK(clk_i),
    .D(_024_),
    .RESET_B(net13),
    .Q(net5));
 sky130_fd_sc_hd__dfrtp_1 _187_ (.CLK(clk_i),
    .D(_025_),
    .RESET_B(net13),
    .Q(net6));
 sky130_fd_sc_hd__dfrtp_1 _188_ (.CLK(clk_i),
    .D(\rng_rd.wr_ff2 ),
    .RESET_B(net15),
    .Q(\rng_rd.wr_ff2_d ));
 sky130_fd_sc_hd__dfrtp_1 _189_ (.CLK(clk_i),
    .D(_026_),
    .RESET_B(net16),
    .Q(\num_i_bar[0] ));
 sky130_fd_sc_hd__dfrtp_1 _190_ (.CLK(clk_i),
    .D(_027_),
    .RESET_B(net16),
    .Q(\num_i_bar[1] ));
 sky130_fd_sc_hd__dfrtp_1 _191_ (.CLK(clk_i),
    .D(_028_),
    .RESET_B(net16),
    .Q(\num_i_bar[2] ));
 sky130_fd_sc_hd__dfrtp_1 _192_ (.CLK(clk_i),
    .D(_000_),
    .RESET_B(net15),
    .Q(req_num_again));
 sky130_fd_sc_hd__dfrtp_1 _193_ (.CLK(clk_i),
    .D(_029_),
    .RESET_B(net15),
    .Q(\rng_rd.ram_6[0] ));
 sky130_fd_sc_hd__dfrtp_1 _194_ (.CLK(clk_i),
    .D(_030_),
    .RESET_B(net16),
    .Q(\rng_rd.ram_6[1] ));
 sky130_fd_sc_hd__dfrtp_1 _195_ (.CLK(clk_i),
    .D(_031_),
    .RESET_B(net14),
    .Q(\rng_rd.ram_6[2] ));
 sky130_fd_sc_hd__dfrtp_1 _196_ (.CLK(clk_i),
    .D(_001_),
    .RESET_B(net16),
    .Q(\rng_rd.wr_pulse ));
