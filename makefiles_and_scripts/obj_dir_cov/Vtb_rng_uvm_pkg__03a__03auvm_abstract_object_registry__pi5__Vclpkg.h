...
#ifndef VERILATED_VTB_RNG_UVM_PKG__03A__03AUVM_ABSTRACT_OBJECT_REGISTRY__PI5__VCLPKG_H_
#define VERILATED_VTB_RNG_UVM_PKG__03A__03AUVM_ABSTRACT_OBJECT_REGISTRY__PI5__VCLPKG_H_  // guard
...
class Vtb_rng_uvm_pkg__03a__03auvm_registry_common__pi22;
class Vtb_rng_uvm_pkg__03a__03auvm_root;


class Vtb_rng__Syms;

class alignas(VL_CACHE_LINE_BYTES) Vtb_rng_uvm_pkg__03a__03auvm_abstract_object_registry__pi5__Vclpkg final {
  public:

    // DESIGN SPECIFIC STATE
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_abstract_object_registry__pi5> __PVT__get__Vstatic__m_inst;
    ...
    // CONSTRUCTORS
    Vtb_rng_uvm_pkg__03a__03auvm_abstract_object_registry__pi5__Vclpkg();
    ~Vtb_rng_uvm_pkg__03a__03auvm_abstract_object_registry__pi5__Vclpkg();
    void ctor(Vtb_rng__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vtb_rng_uvm_pkg__03a__03auvm_abstract_object_registry__pi5__Vclpkg);
    ...
    void __VnoInFunc_create(Vtb_rng__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_component> parent, std::string contxt, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_recorder> &create__Vfuncrtn);
    void __VnoInFunc_get(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_abstract_object_registry__pi5> &get__Vfuncrtn);
...
class Vtb_rng_uvm_pkg__03a__03auvm_abstract_object_registry__pi5 : public Vtb_rng_uvm_pkg__03a__03auvm_object_wrapper {
  public:
    ...
    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_abstract_object_registry__pi5"; }
    VlClass* clone() const { return new Vtb_rng_uvm_pkg__03a__03auvm_abstract_object_registry__pi5(*this); }
  ...
  public:
    Vtb_rng_uvm_pkg__03a__03auvm_abstract_object_registry__pi5() = default;
    void init(Vtb_rng__Syms* __restrict vlSymsp);
    virtual std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vtb_rng_uvm_pkg__03a__03auvm_abstract_object_registry__pi5();
};
