...
#ifndef VERILATED_VTB_RNG_UVM_PKG__03A__03AUVM_SIMPLE_LOCK_DAP__TZ2__VCLPKG_H_
#define VERILATED_VTB_RNG_UVM_PKG__03A__03AUVM_SIMPLE_LOCK_DAP__TZ2__VCLPKG_H_  // guard
...
class Vtb_rng_uvm_pkg__03a__03auvm_set_get_dap_base__Tz2;
class Vtb_rng_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2;


class Vtb_rng__Syms;

class alignas(VL_CACHE_LINE_BYTES) Vtb_rng_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vtb_rng_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2__Vclpkg();
    ~Vtb_rng_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2__Vclpkg();
    void ctor(Vtb_rng__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vtb_rng_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2__Vclpkg);
    ...
    void __VnoInFunc_get_type(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_object_registry__Tz265> &get_type__Vfuncrtn);
};
...
class Vtb_rng_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2 : public Vtb_rng_uvm_pkg__03a__03auvm_set_get_dap_base__Tz2 {
  public:
    ...
    VlClass* clone() const { return new Vtb_rng_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2(*this); }
    ...
    void __VnoInFunc_lock(Vtb_rng__Syms* __restrict vlSymsp);
    ...
    void __VnoInFunc_unlock(Vtb_rng__Syms* __restrict vlSymsp);
  private:
    void _ctor_var_reset(Vtb_rng__Syms* __restrict vlSymsp);
  public:
    Vtb_rng_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2() = default;
    void init(VlProcessRef vlProcess, Vtb_rng__Syms* __restrict vlSymsp, std::string name);
    virtual std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vtb_rng_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2();
};
