...
#ifndef VERILATED_VTB_RNG_UVM_PKG__03A__03AUVM_TLM_IF_BASE__TZ26_TBZ26__VCLPKG_H_
#define VERILATED_VTB_RNG_UVM_PKG__03A__03AUVM_TLM_IF_BASE__TZ26_TBZ26__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtb_rng_uvm_pkg__03a__03auvm_tlm_if_base__Tz26_TBz26__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vtb_rng_uvm_pkg__03a__03auvm_tlm_if_base__Tz26_TBz26__Vclpkg();
    ~Vtb_rng_uvm_pkg__03a__03auvm_tlm_if_base__Tz26_TBz26__Vclpkg();
    void ctor(Vtb_rng__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vtb_rng_uvm_pkg__03a__03auvm_tlm_if_base__Tz26_TBz26__Vclpkg);
...
class Vtb_rng_uvm_pkg__03a__03auvm_tlm_if_base__Tz26_TBz26 : public virtual VlClass {
  public:
    ...
    virtual void __VnoInFunc_nb_transport(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_sequence_item> req, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_sequence_item> &rsp, CData/*0:0*/ &nb_transport__Vfuncrtn);
    ...
    virtual void __VnoInFunc_transport(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_sequence_item> req, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_sequence_item> &rsp);
    ...
    virtual void __VnoInFunc_try_put(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_sequence_item> t, CData/*0:0*/ &try_put__Vfuncrtn);
    virtual void __VnoInFunc_write(VlProcessRef vlProcess, Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_sequence_item> t);
  private:
    void _ctor_var_reset(Vtb_rng__Syms* __restrict vlSymsp);
  public:
    Vtb_rng_uvm_pkg__03a__03auvm_tlm_if_base__Tz26_TBz26() = default;
    void init(VlProcessRef vlProcess, Vtb_rng__Syms* __restrict vlSymsp);
    virtual std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vtb_rng_uvm_pkg__03a__03auvm_tlm_if_base__Tz26_TBz26();
};
