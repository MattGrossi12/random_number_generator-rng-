...
#ifndef VERILATED_VTB_RNG_UVM_PKG__03A__03AUVM_GET_TO_LOCK_DAP__TZ30__VCLPKG_H_
#define VERILATED_VTB_RNG_UVM_PKG__03A__03AUVM_GET_TO_LOCK_DAP__TZ30__VCLPKG_H_  // guard
...
class Vtb_rng_uvm_pkg__03a__03auvm_set_get_dap_base__Tz30;


class Vtb_rng__Syms;

class alignas(VL_CACHE_LINE_BYTES) Vtb_rng_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz30__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vtb_rng_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz30__Vclpkg();
    ~Vtb_rng_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz30__Vclpkg();
    void ctor(Vtb_rng__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vtb_rng_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz30__Vclpkg);
    ...
    void __VnoInFunc_get_type(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_object_registry__Tz80> &get_type__Vfuncrtn);
};
...
class Vtb_rng_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz30 : public Vtb_rng_uvm_pkg__03a__03auvm_set_get_dap_base__Tz30 {
  public:
    ...
    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_get_to_lock_dap__Tz30"; }
    VlClass* clone() const { return new Vtb_rng_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz30(*this); }
    ...
    virtual void __VnoInFunc_get(Vtb_rng__Syms* __restrict vlSymsp, CData/*0:0*/ &get__Vfuncrtn);
    ...
    virtual void __VnoInFunc_set(VlProcessRef vlProcess, Vtb_rng__Syms* __restrict vlSymsp, CData/*0:0*/ value);
    virtual void __VnoInFunc_try_get(Vtb_rng__Syms* __restrict vlSymsp, CData/*0:0*/ &value, CData/*0:0*/ &try_get__Vfuncrtn);
    virtual void __VnoInFunc_try_set(Vtb_rng__Syms* __restrict vlSymsp, CData/*0:0*/ value, CData/*0:0*/ &try_set__Vfuncrtn);
  private:
    void _ctor_var_reset(Vtb_rng__Syms* __restrict vlSymsp);
  public:
    Vtb_rng_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz30() = default;
    void init(VlProcessRef vlProcess, Vtb_rng__Syms* __restrict vlSymsp, std::string name);
    virtual std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vtb_rng_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz30();
};
