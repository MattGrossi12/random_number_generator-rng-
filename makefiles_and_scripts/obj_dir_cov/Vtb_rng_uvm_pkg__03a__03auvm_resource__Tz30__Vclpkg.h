...
#ifndef VERILATED_VTB_RNG_UVM_PKG__03A__03AUVM_RESOURCE__TZ30__VCLPKG_H_
#define VERILATED_VTB_RNG_UVM_PKG__03A__03AUVM_RESOURCE__TZ30__VCLPKG_H_  // guard
...
class Vtb_rng_uvm_pkg__03a__03auvm_object_registry__Tz381;
...
class alignas(VL_CACHE_LINE_BYTES) Vtb_rng_uvm_pkg__03a__03auvm_resource__Tz30__Vclpkg final {
  public:

    // DESIGN SPECIFIC STATE
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_resource__Tz30> __PVT__my_type;
    ...
    // CONSTRUCTORS
    Vtb_rng_uvm_pkg__03a__03auvm_resource__Tz30__Vclpkg();
    ~Vtb_rng_uvm_pkg__03a__03auvm_resource__Tz30__Vclpkg();
    void ctor(Vtb_rng__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vtb_rng_uvm_pkg__03a__03auvm_resource__Tz30__Vclpkg);
    ...
    void __VnoInFunc_get_highest_precedence(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz5> &q, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_resource__Tz30> &get_highest_precedence__Vfuncrtn);
    void __VnoInFunc_get_type(VlProcessRef vlProcess, Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_resource__Tz30> &get_type__Vfuncrtn);
...
class Vtb_rng_uvm_pkg__03a__03auvm_resource__Tz30 : public Vtb_rng_uvm_pkg__03a__03auvm_resource_base {
  public:
    ...
    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_resource__Tz30"; }
    VlClass* clone() const { return new Vtb_rng_uvm_pkg__03a__03auvm_resource__Tz30(*this); }
    ...
    void __VnoInFunc_read(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_object> accessor, CData/*0:0*/ &read__Vfuncrtn);
  ...
  public:
    Vtb_rng_uvm_pkg__03a__03auvm_resource__Tz30() = default;
    void init(VlProcessRef vlProcess, Vtb_rng__Syms* __restrict vlSymsp, std::string name);
    virtual std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vtb_rng_uvm_pkg__03a__03auvm_resource__Tz30();
};
