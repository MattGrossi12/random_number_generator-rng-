...
#ifndef VERILATED_VTB_RNG_UVM_PKG__03A__03AUVM_CALLBACKS__TZ13__VCLPKG_H_
#define VERILATED_VTB_RNG_UVM_PKG__03A__03AUVM_CALLBACKS__TZ13__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtb_rng_uvm_pkg__03a__03auvm_callbacks__Tz13__Vclpkg final {
  public:
    ...
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_callbacks__Tz13> __PVT__m_inst;
    ...
    // CONSTRUCTORS
    Vtb_rng_uvm_pkg__03a__03auvm_callbacks__Tz13__Vclpkg();
    ~Vtb_rng_uvm_pkg__03a__03auvm_callbacks__Tz13__Vclpkg();
    void ctor(Vtb_rng__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vtb_rng_uvm_pkg__03a__03auvm_callbacks__Tz13__Vclpkg);
    ...
    void __VnoInFunc_get(VlProcessRef vlProcess, Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_callbacks__Tz13> &get__Vfuncrtn);
    void __VnoInFunc_get_all(Vtb_rng__Syms* __restrict vlSymsp, VlQueue<VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_callback>> &all_callbacks, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_phase> obj);
    void __VnoInFunc_get_first(Vtb_rng__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_phase> obj, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_callback> &get_first__Vfuncrtn);
    void __VnoInFunc_get_last(Vtb_rng__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_phase> obj, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_callback> &get_last__Vfuncrtn);
    void __VnoInFunc_get_next(Vtb_rng__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_phase> obj, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_callback> &get_next__Vfuncrtn);
    void __VnoInFunc_get_prev(Vtb_rng__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_phase> obj, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_callback> &get_prev__Vfuncrtn);
    void __VnoInFunc_m_get_q(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz48> &q, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_phase> obj);
...
class Vtb_rng_uvm_pkg__03a__03auvm_callbacks__Tz13 : public Vtb_rng_uvm_pkg__03a__03auvm_typed_callbacks__Tz13 {
  public:
    ...
    VlClass* clone() const { return new Vtb_rng_uvm_pkg__03a__03auvm_callbacks__Tz13(*this); }
  ...
  public:
    Vtb_rng_uvm_pkg__03a__03auvm_callbacks__Tz13() = default;
    void init(VlProcessRef vlProcess, Vtb_rng__Syms* __restrict vlSymsp);
    virtual std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vtb_rng_uvm_pkg__03a__03auvm_callbacks__Tz13();
};
