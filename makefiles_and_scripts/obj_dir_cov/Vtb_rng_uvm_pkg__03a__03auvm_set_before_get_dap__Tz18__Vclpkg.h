...
#ifndef VERILATED_VTB_RNG_UVM_PKG__03A__03AUVM_SET_BEFORE_GET_DAP__TZ18__VCLPKG_H_
#define VERILATED_VTB_RNG_UVM_PKG__03A__03AUVM_SET_BEFORE_GET_DAP__TZ18__VCLPKG_H_  // guard
...
class Vtb_rng_uvm_pkg__03a__03auvm_object_registry__Tz72;
...
class Vtb_rng_uvm_pkg__03a__03auvm_set_get_dap_base__Tz18;


class Vtb_rng__Syms;

class alignas(VL_CACHE_LINE_BYTES) Vtb_rng_uvm_pkg__03a__03auvm_set_before_get_dap__Tz18__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vtb_rng_uvm_pkg__03a__03auvm_set_before_get_dap__Tz18__Vclpkg();
    ~Vtb_rng_uvm_pkg__03a__03auvm_set_before_get_dap__Tz18__Vclpkg();
    void ctor(Vtb_rng__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vtb_rng_uvm_pkg__03a__03auvm_set_before_get_dap__Tz18__Vclpkg);
    ...
    void __VnoInFunc_get_type(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_object_registry__Tz72> &get_type__Vfuncrtn);
};
...
class Vtb_rng_uvm_pkg__03a__03auvm_set_before_get_dap__Tz18 : public Vtb_rng_uvm_pkg__03a__03auvm_set_get_dap_base__Tz18 {
  public:
    ...
    VlClassRef<Vtb_rng_uvm_pkg__03a__03am_uvm_tr_stream_cfg> __PVT__m_value;

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_set_before_get_dap__Tz18"; }
    VlClass* clone() const { return new Vtb_rng_uvm_pkg__03a__03auvm_set_before_get_dap__Tz18(*this); }
    ...
    virtual void __VnoInFunc_get(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03am_uvm_tr_stream_cfg> &get__Vfuncrtn);
    ...
    virtual void __VnoInFunc_set(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03am_uvm_tr_stream_cfg> value);
    virtual void __VnoInFunc_try_get(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03am_uvm_tr_stream_cfg> &value, CData/*0:0*/ &try_get__Vfuncrtn);
    virtual void __VnoInFunc_try_set(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03am_uvm_tr_stream_cfg> value, CData/*0:0*/ &try_set__Vfuncrtn);
  private:
    void _ctor_var_reset(Vtb_rng__Syms* __restrict vlSymsp);
  public:
    Vtb_rng_uvm_pkg__03a__03auvm_set_before_get_dap__Tz18() = default;
    void init(VlProcessRef vlProcess, Vtb_rng__Syms* __restrict vlSymsp, std::string name);
    virtual std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vtb_rng_uvm_pkg__03a__03auvm_set_before_get_dap__Tz18();
};
