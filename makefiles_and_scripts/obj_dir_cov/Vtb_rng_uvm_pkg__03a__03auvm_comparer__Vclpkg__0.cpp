...
void Vtb_rng_uvm_pkg__03a__03auvm_comparer__Vclpkg::__VnoInFunc_get_type(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_object_registry__pi12> &get_type__Vfuncrtn) {
...
void Vtb_rng_uvm_pkg__03a__03auvm_comparer__Vclpkg::__VnoInFunc_set_default(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_comparer> comparer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtb_rng_uvm_pkg__03a__03auvm_comparer__Vclpkg::__VnoInFunc_set_default\n"); );
    // Body
...
void Vtb_rng_uvm_pkg__03a__03auvm_comparer__Vclpkg::__VnoInFunc_get_default(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_comparer> &get_default__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtb_rng_uvm_pkg__03a__03auvm_comparer__Vclpkg::__VnoInFunc_get_default\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_coreservice_t> coreservice;
    vlSymsp->TOP__uvm_pkg__03a__03auvm_coreservice_t__Vclpkg.__VnoInFunc_get(vlProcess, vlSymsp, coreservice);
...
std::string VL_TO_STRING(const Vtb_rng_state_info_t__struct__0& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtb_rng_uvm_pkg__03a__03auvm_comparer__Vclpkg::VL_TO_STRING\n"); );
    // Body
    std::string out;
...
void Vtb_rng_uvm_pkg__03a__03auvm_comparer::__VnoInFunc_get_object_type(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_object_wrapper> &get_object_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtb_rng_uvm_pkg__03a__03auvm_comparer::__VnoInFunc_get_object_type\n"); );
    // Locals
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_object_registry__pi12> __Vfunc_get__0__Vfuncout;
    // Body
...
void Vtb_rng_uvm_pkg__03a__03auvm_comparer::__VnoInFunc_create(VlProcessRef vlProcess, Vtb_rng__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_object> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtb_rng_uvm_pkg__03a__03auvm_comparer::__VnoInFunc_create\n"); );
    // Body
...
void Vtb_rng_uvm_pkg__03a__03auvm_comparer::init(VlProcessRef vlProcess, Vtb_rng__Syms* __restrict vlSymsp, std::string name) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtb_rng_uvm_pkg__03a__03auvm_comparer::new\n"); );
    // Body
...
void Vtb_rng_uvm_pkg__03a__03auvm_comparer::__VnoInFunc_compare_field(Vtb_rng__Syms* __restrict vlSymsp, std::string name, VlWide<128>/*4095:0*/ lhs, VlWide<128>/*4095:0*/ rhs, IData/*31:0*/ size, IData/*27:0*/ radix, CData/*0:0*/ &compare_field__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtb_rng_uvm_pkg__03a__03auvm_comparer::__VnoInFunc_compare_field\n"); );
    // Locals
    ...
    IData/*31:0*/ __Vilp1;
    IData/*31:0*/ __Vdeeptemp_h8a1f2e14__0;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    ...
    std::string msg;
    {
        ...
        __Vdeeptemp_h8a1f2e14__0 = ((((((((((((((((
                                    ...
                                    | ((lhs[117U] & mask[117U]) 
                                       ^ (rhs[117U] 
                                          & mask[117U])));
        if ((0U != ((((((((((__Vdeeptemp_h8a1f2e14__0 
                             | ((lhs[118U] & mask[118U]) 
                                ^ (rhs[118U] & mask[118U]))) 
                            | ((lhs[119U] & mask[119U]) 
                               ^ (rhs[119U] & mask[119U]))) 
