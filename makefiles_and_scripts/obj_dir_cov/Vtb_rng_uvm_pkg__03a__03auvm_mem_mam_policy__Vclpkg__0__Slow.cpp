...
VL_ATTR_COLD void Vtb_rng_uvm_pkg__03a__03auvm_mem_mam_policy__Vclpkg___configure_coverage(Vtb_rng_uvm_pkg__03a__03auvm_mem_mam_policy__Vclpkg* vlSelf, bool first) {
    ...
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[22643]), first, "/home/matheus/tools/1800.2-2017-1.0/src/reg/uvm_mem_mam.svh", 458, 1, "", "v_line/uvm_mem_mam_policy", "block", "458");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[22644]), first, "/home/matheus/tools/1800.2-2017-1.0/src/reg/uvm_mem_mam.svh", 458, 1, "", "v_line/uvm_mem_mam_policy", "block", "458");
}
