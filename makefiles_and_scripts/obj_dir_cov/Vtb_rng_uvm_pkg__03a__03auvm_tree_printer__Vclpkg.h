...
#ifndef VERILATED_VTB_RNG_UVM_PKG__03A__03AUVM_TREE_PRINTER__VCLPKG_H_
#define VERILATED_VTB_RNG_UVM_PKG__03A__03AUVM_TREE_PRINTER__VCLPKG_H_  // guard
...
class Vtb_rng_uvm_pkg__03a__03auvm_object_registry__pi10;
...
class alignas(VL_CACHE_LINE_BYTES) Vtb_rng_uvm_pkg__03a__03auvm_tree_printer__Vclpkg final {
  public:

    // DESIGN SPECIFIC STATE
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_tree_printer> __PVT__m_default_tree_printer;
    ...
    // CONSTRUCTORS
    Vtb_rng_uvm_pkg__03a__03auvm_tree_printer__Vclpkg();
    ~Vtb_rng_uvm_pkg__03a__03auvm_tree_printer__Vclpkg();
    void ctor(Vtb_rng__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vtb_rng_uvm_pkg__03a__03auvm_tree_printer__Vclpkg);
    ...
    void __VnoInFunc_get_default(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_tree_printer> &get_default__Vfuncrtn);
    void __VnoInFunc_get_type(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_object_registry__pi10> &get_type__Vfuncrtn);
    void __VnoInFunc_set_default(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_tree_printer> printer);
...
class Vtb_rng_uvm_pkg__03a__03auvm_tree_printer : public Vtb_rng_uvm_pkg__03a__03auvm_printer {
  public:
    ...
    VlClass* clone() const { return new Vtb_rng_uvm_pkg__03a__03auvm_tree_printer(*this); }
  ...
  public:
    Vtb_rng_uvm_pkg__03a__03auvm_tree_printer() = default;
    void init(VlProcessRef vlProcess, Vtb_rng__Syms* __restrict vlSymsp, std::string name);
    virtual std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vtb_rng_uvm_pkg__03a__03auvm_tree_printer();
};
