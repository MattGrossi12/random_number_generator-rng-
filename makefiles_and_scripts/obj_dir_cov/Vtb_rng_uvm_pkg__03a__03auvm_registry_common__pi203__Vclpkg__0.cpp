...
void Vtb_rng_uvm_pkg__03a__03auvm_registry_common__pi203__Vclpkg::__VnoInFunc_type_name(Vtb_rng__Syms* __restrict vlSymsp, std::string &type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtb_rng_uvm_pkg__03a__03auvm_registry_common__pi203__Vclpkg::__VnoInFunc_type_name\n"); );
    // Body
...
void Vtb_rng_uvm_pkg__03a__03auvm_registry_common__pi203__Vclpkg::__VnoInFunc_get(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_registry_common__pi203> &get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtb_rng_uvm_pkg__03a__03auvm_registry_common__pi203__Vclpkg::__VnoInFunc_get\n"); );
    // Body
    if ((VlNull{} == this->__PVT__get__Vstatic__m_inst)) {
        this->__PVT__get__Vstatic__m_inst = VL_NEW(Vtb_rng_uvm_pkg__03a__03auvm_registry_common__pi203, vlSymsp);
...
void Vtb_rng_uvm_pkg__03a__03auvm_registry_common__pi203__Vclpkg::__VnoInFunc_create(Vtb_rng__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_component> parent, std::string contxt, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_reg_tlm_adapter> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtb_rng_uvm_pkg__03a__03auvm_registry_common__pi203__Vclpkg::__VnoInFunc_create\n"); );
    // Body
    ...
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_object_registry__pi180> __VlefCall_0__get;
    ...
    vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__pi180__Vclpkg.__VnoInFunc_get(vlSymsp, __VlefCall_0__get);
    ...
    if (__VlefExpr_1) {
        ...
        vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__pi180__Vclpkg.__VnoInFunc_type_name(vlSymsp, __VlefCall_3__type_name);
        if ((VlNull{} == obj)) {
...
void Vtb_rng_uvm_pkg__03a__03auvm_registry_common__pi203__Vclpkg::__VnoInFunc_set_type_override(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_object_wrapper> override_type, CData/*0:0*/ replace) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtb_rng_uvm_pkg__03a__03auvm_registry_common__pi203__Vclpkg::__VnoInFunc_set_type_override\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_object_registry__pi180> __VlefCall_0__get;
...
void Vtb_rng_uvm_pkg__03a__03auvm_registry_common__pi203__Vclpkg::__VnoInFunc_set_inst_override(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_object_wrapper> override_type, std::string inst_path, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_component> parent) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtb_rng_uvm_pkg__03a__03auvm_registry_common__pi203__Vclpkg::__VnoInFunc_set_inst_override\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_object_registry__pi180> __VlefCall_1__get;
    ...
    vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__pi180__Vclpkg.__VnoInFunc_get(vlSymsp, __VlefCall_1__get);
...
void Vtb_rng_uvm_pkg__03a__03auvm_registry_common__pi203__Vclpkg::__VnoInFunc_set_type_alias(Vtb_rng__Syms* __restrict vlSymsp, std::string alias_name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtb_rng_uvm_pkg__03a__03auvm_registry_common__pi203__Vclpkg::__VnoInFunc_set_type_alias\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    ...
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_object_registry__pi180> unnamedblk2__DOT__rgtry;
    ...
    if ((0U != __VlefCall_0__get_core_state)) {
        ...
        vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__pi180__Vclpkg.__VnoInFunc_get(vlSymsp, unnamedblk2__DOT__rgtry);
...
void Vtb_rng_uvm_pkg__03a__03auvm_registry_common__pi203__Vclpkg::__VnoInFunc____05Fdeferred_init(VlProcessRef vlProcess, Vtb_rng__Syms* __restrict vlSymsp, CData/*0:0*/ &___05Fdeferred_init__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtb_rng_uvm_pkg__03a__03auvm_registry_common__pi203__Vclpkg::__VnoInFunc____05Fdeferred_init\n"); );
    // Body
    IData/*31:0*/ __VlefCall_0__get_core_state;
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_object_registry__pi180> rgtry;
    ___05Fdeferred_init__Vfuncrtn = 0U;
    vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__pi180__Vclpkg.__VnoInFunc_get(vlSymsp, rgtry);
    __VlefCall_0__get_core_state = vlSymsp->TOP__uvm_pkg.__PVT__m_uvm_core_state;
    ++(vlSymsp->__Vcoverage[459]);
    if ((0U == __VlefCall_0__get_core_state)) {
...
void Vtb_rng_uvm_pkg__03a__03auvm_registry_common__pi203::__VnoInFunc_get_type_name(Vtb_rng__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtb_rng_uvm_pkg__03a__03auvm_registry_common__pi203::__VnoInFunc_get_type_name\n"); );
    // Body
    get_type_name__Vfuncrtn = ""s;
    vlSymsp->TOP__uvm_pkg__03a__03auvm_registry_common__pi203__Vclpkg.__VnoInFunc_type_name(vlSymsp, get_type_name__Vfuncrtn);
    ++(vlSymsp->__Vcoverage[5309]);
}

void Vtb_rng_uvm_pkg__03a__03auvm_registry_common__pi203::__VnoInFunc_initialize(VlProcessRef vlProcess, Vtb_rng__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtb_rng_uvm_pkg__03a__03auvm_registry_common__pi203::__VnoInFunc_initialize\n"); );
    // Body
    ...
    while (VL_LTS_III(32, unnamedblk3__DOT__i, vlSymsp->TOP__uvm_pkg__03a__03auvm_registry_common__pi203__Vclpkg.__PVT__m___05Ftype_aliases.size())) {
        VL_NULL_CHECK(factory, "/home/matheus/tools/1800.2-2017-1.0/src/base/uvm_registry.svh", 629)->__VnoInFunc_set_type_alias(vlProcess, vlSymsp, 
                                                                                VL_CVT_PACK_STR_NN(vlSymsp->TOP__uvm_pkg__03a__03auvm_registry_common__pi203__Vclpkg.__PVT__m___05Ftype_aliases.at(unnamedblk3__DOT__i)), rgtry);
...
void Vtb_rng_uvm_pkg__03a__03auvm_registry_common__pi203::init(Vtb_rng__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtb_rng_uvm_pkg__03a__03auvm_registry_common__pi203::new\n"); );
    // Body
    _ctor_var_reset(vlSymsp);
    ++(vlSymsp->__Vcoverage[5335]);
}

void Vtb_rng_uvm_pkg__03a__03auvm_registry_common__pi203::_ctor_var_reset(Vtb_rng__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtb_rng_uvm_pkg__03a__03auvm_registry_common__pi203::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
}

std::string Vtb_rng_uvm_pkg__03a__03auvm_registry_common__pi203::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtb_rng_uvm_pkg__03a__03auvm_registry_common__pi203::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vtb_rng_uvm_pkg__03a__03auvm_registry_common__pi203::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtb_rng_uvm_pkg__03a__03auvm_registry_common__pi203::to_string_middle\n"); );
    // Body
    return (""s);
}
