...
void Vtb_rng_uvm_pkg__03a__03auvm_resource_db__Tz2__Vclpkg::__VnoInFunc_get_by_type(Vtb_rng__Syms* __restrict vlSymsp, std::string scope, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_resource__Tz2> &get_by_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtb_rng_uvm_pkg__03a__03auvm_resource_db__Tz2__Vclpkg::__VnoInFunc_get_by_type\n"); );
    // Locals
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_resource__Tz2> __Vfunc_get_type__1__Vfuncout;
    ...
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_resource__Tz2> rsrc;
    std::string msg;
...
void Vtb_rng_uvm_pkg__03a__03auvm_resource_db__Tz2__Vclpkg::__VnoInFunc_get_by_name(Vtb_rng__Syms* __restrict vlSymsp, std::string scope, std::string name, CData/*0:0*/ rpterr, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_resource__Tz2> &get_by_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtb_rng_uvm_pkg__03a__03auvm_resource_db__Tz2__Vclpkg::__VnoInFunc_get_by_name\n"); );
    // Locals
    ...
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_resource__Tz2> __VlefCall_0__get_type;
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_resource_pool> rp;
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_resource_base> rsrc_base;
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_resource__Tz2> rsrc;
    std::string msg;
...
void Vtb_rng_uvm_pkg__03a__03auvm_resource_db__Tz2__Vclpkg::__VnoInFunc_set_default(Vtb_rng__Syms* __restrict vlSymsp, std::string scope, std::string name, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_resource__Tz2> &set_default__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtb_rng_uvm_pkg__03a__03auvm_resource_db__Tz2__Vclpkg::__VnoInFunc_set_default\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_resource__Tz2> r;
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_resource_pool> rp;
    vlSymsp->TOP__uvm_pkg__03a__03auvm_resource_pool__Vclpkg.__VnoInFunc_get(vlProcess, vlSymsp, rp);
    r = VL_NEW(Vtb_rng_uvm_pkg__03a__03auvm_resource__Tz2, vlProcess, vlSymsp, name);
...
void Vtb_rng_uvm_pkg__03a__03auvm_resource_db__Tz2__Vclpkg::__VnoInFunc_m_show_msg(VlProcessRef vlProcess, Vtb_rng__Syms* __restrict vlSymsp, std::string id, std::string rtype, std::string action, std::string scope, std::string name, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_object> accessor, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_resource__Tz2> rsrc) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtb_rng_uvm_pkg__03a__03auvm_resource_db__Tz2__Vclpkg::__VnoInFunc_m_show_msg\n"); );
    // Locals
...
void Vtb_rng_uvm_pkg__03a__03auvm_resource_db__Tz2__Vclpkg::__VnoInFunc_set(Vtb_rng__Syms* __restrict vlSymsp, std::string scope, std::string name, std::string val, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_object> accessor) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtb_rng_uvm_pkg__03a__03auvm_resource_db__Tz2__Vclpkg::__VnoInFunc_set\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    ...
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_resource__Tz2> rsrc;
    vlSymsp->TOP__uvm_pkg__03a__03auvm_resource_pool__Vclpkg.__VnoInFunc_get(vlProcess, vlSymsp, rp);
    rsrc = VL_NEW(Vtb_rng_uvm_pkg__03a__03auvm_resource__Tz2, vlProcess, vlSymsp, name);
...
void Vtb_rng_uvm_pkg__03a__03auvm_resource_db__Tz2__Vclpkg::__VnoInFunc_set_anonymous(Vtb_rng__Syms* __restrict vlSymsp, std::string scope, std::string val, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_object> accessor) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtb_rng_uvm_pkg__03a__03auvm_resource_db__Tz2__Vclpkg::__VnoInFunc_set_anonymous\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    CData/*0:0*/ __VlefCall_0__is_tracing;
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_resource_pool> rp;
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_resource__Tz2> rsrc;
    vlSymsp->TOP__uvm_pkg__03a__03auvm_resource_pool__Vclpkg.__VnoInFunc_get(vlProcess, vlSymsp, rp);
    rsrc = VL_NEW(Vtb_rng_uvm_pkg__03a__03auvm_resource__Tz2, vlProcess, vlSymsp, ""s);
...
void Vtb_rng_uvm_pkg__03a__03auvm_resource_db__Tz2__Vclpkg::__VnoInFunc_set_override(Vtb_rng__Syms* __restrict vlSymsp, std::string scope, std::string name, std::string val, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_object> accessor) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtb_rng_uvm_pkg__03a__03auvm_resource_db__Tz2__Vclpkg::__VnoInFunc_set_override\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    CData/*0:0*/ __VlefCall_0__is_tracing;
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_resource_pool> rp;
...
void Vtb_rng_uvm_pkg__03a__03auvm_resource_db__Tz2__Vclpkg::__VnoInFunc_set_override_type(Vtb_rng__Syms* __restrict vlSymsp, std::string scope, std::string name, std::string val, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_object> accessor) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtb_rng_uvm_pkg__03a__03auvm_resource_db__Tz2__Vclpkg::__VnoInFunc_set_override_type\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    CData/*0:0*/ __VlefCall_0__is_tracing;
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_resource_pool> rp;
...
void Vtb_rng_uvm_pkg__03a__03auvm_resource_db__Tz2__Vclpkg::__VnoInFunc_set_override_name(Vtb_rng__Syms* __restrict vlSymsp, std::string scope, std::string name, std::string val, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_object> accessor) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtb_rng_uvm_pkg__03a__03auvm_resource_db__Tz2__Vclpkg::__VnoInFunc_set_override_name\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    CData/*0:0*/ __VlefCall_0__is_tracing;
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_resource_pool> rp;
...
void Vtb_rng_uvm_pkg__03a__03auvm_resource_db__Tz2__Vclpkg::__VnoInFunc_read_by_name(Vtb_rng__Syms* __restrict vlSymsp, std::string scope, std::string name, std::string &val, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_object> accessor, CData/*0:0*/ &read_by_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtb_rng_uvm_pkg__03a__03auvm_resource_db__Tz2__Vclpkg::__VnoInFunc_read_by_name\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    CData/*0:0*/ __VlefCall_0__is_tracing;
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_resource__Tz2> rsrc;
...
void Vtb_rng_uvm_pkg__03a__03auvm_resource_db__Tz2__Vclpkg::__VnoInFunc_read_by_type(Vtb_rng__Syms* __restrict vlSymsp, std::string scope, std::string &val, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_object> accessor, CData/*0:0*/ &read_by_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtb_rng_uvm_pkg__03a__03auvm_resource_db__Tz2__Vclpkg::__VnoInFunc_read_by_type\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    CData/*0:0*/ __VlefCall_0__is_tracing;
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_resource__Tz2> rsrc;
...
void Vtb_rng_uvm_pkg__03a__03auvm_resource_db__Tz2__Vclpkg::__VnoInFunc_write_by_name(Vtb_rng__Syms* __restrict vlSymsp, std::string scope, std::string name, std::string val, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_object> accessor, CData/*0:0*/ &write_by_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtb_rng_uvm_pkg__03a__03auvm_resource_db__Tz2__Vclpkg::__VnoInFunc_write_by_name\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    CData/*0:0*/ __VlefCall_0__is_tracing;
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_resource__Tz2> rsrc;
...
void Vtb_rng_uvm_pkg__03a__03auvm_resource_db__Tz2__Vclpkg::__VnoInFunc_write_by_type(Vtb_rng__Syms* __restrict vlSymsp, std::string scope, std::string val, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_object> accessor, CData/*0:0*/ &write_by_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtb_rng_uvm_pkg__03a__03auvm_resource_db__Tz2__Vclpkg::__VnoInFunc_write_by_type\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    CData/*0:0*/ __VlefCall_0__is_tracing;
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_resource__Tz2> rsrc;
...
void Vtb_rng_uvm_pkg__03a__03auvm_resource_db__Tz2__Vclpkg::__VnoInFunc_dump(Vtb_rng__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtb_rng_uvm_pkg__03a__03auvm_resource_db__Tz2__Vclpkg::__VnoInFunc_dump\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_resource_pool> rp;
    vlSymsp->TOP__uvm_pkg__03a__03auvm_resource_pool__Vclpkg.__VnoInFunc_get(vlProcess, vlSymsp, rp);
...
void Vtb_rng_uvm_pkg__03a__03auvm_resource_db__Tz2::init(Vtb_rng__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_resource_db__Tz2::new\n"); );
    // Body
    _ctor_var_reset(vlSymsp);
    ++(vlSymsp->__Vcoverage[9014]);
}

void Vtb_rng_uvm_pkg__03a__03auvm_resource_db__Tz2::_ctor_var_reset(Vtb_rng__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_resource_db__Tz2::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
}

Vtb_rng_uvm_pkg__03a__03auvm_resource_db__Tz2::~Vtb_rng_uvm_pkg__03a__03auvm_resource_db__Tz2() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_resource_db__Tz2::~\n"); );
}

std::string Vtb_rng_uvm_pkg__03a__03auvm_resource_db__Tz2::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_resource_db__Tz2::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vtb_rng_uvm_pkg__03a__03auvm_resource_db__Tz2::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_resource_db__Tz2::to_string_middle\n"); );
    // Body
    return (""s);
}
