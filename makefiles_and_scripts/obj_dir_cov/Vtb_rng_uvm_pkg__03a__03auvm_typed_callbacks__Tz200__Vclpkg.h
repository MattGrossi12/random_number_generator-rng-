...
#ifndef VERILATED_VTB_RNG_UVM_PKG__03A__03AUVM_TYPED_CALLBACKS__TZ200__VCLPKG_H_
#define VERILATED_VTB_RNG_UVM_PKG__03A__03AUVM_TYPED_CALLBACKS__TZ200__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtb_rng_uvm_pkg__03a__03auvm_typed_callbacks__Tz200__Vclpkg final {
  public:
    ...
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_typed_callbacks__Tz200> __PVT__m_t_inst;
    ...
    // CONSTRUCTORS
    Vtb_rng_uvm_pkg__03a__03auvm_typed_callbacks__Tz200__Vclpkg();
    ~Vtb_rng_uvm_pkg__03a__03auvm_typed_callbacks__Tz200__Vclpkg();
    void ctor(Vtb_rng__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vtb_rng_uvm_pkg__03a__03auvm_typed_callbacks__Tz200__Vclpkg);
    ...
    void __VnoInFunc_m_initialize(VlProcessRef vlProcess, Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_typed_callbacks__Tz200> &m_initialize__Vfuncrtn);
};
...
class Vtb_rng_uvm_pkg__03a__03auvm_typed_callbacks__Tz200 : public Vtb_rng_uvm_pkg__03a__03auvm_callbacks_base {
  public:

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_typed_callbacks__Tz200"; }
    VlClass* clone() const { return new Vtb_rng_uvm_pkg__03a__03auvm_typed_callbacks__Tz200(*this); }
  ...
  public:
    Vtb_rng_uvm_pkg__03a__03auvm_typed_callbacks__Tz200() = default;
    void init(VlProcessRef vlProcess, Vtb_rng__Syms* __restrict vlSymsp);
    virtual std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vtb_rng_uvm_pkg__03a__03auvm_typed_callbacks__Tz200();
};
