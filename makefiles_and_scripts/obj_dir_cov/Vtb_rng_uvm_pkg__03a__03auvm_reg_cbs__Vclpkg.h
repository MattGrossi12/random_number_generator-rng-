...
#ifndef VERILATED_VTB_RNG_UVM_PKG__03A__03AUVM_REG_CBS__VCLPKG_H_
#define VERILATED_VTB_RNG_UVM_PKG__03A__03AUVM_REG_CBS__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtb_rng_uvm_pkg__03a__03auvm_reg_cbs__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vtb_rng_uvm_pkg__03a__03auvm_reg_cbs__Vclpkg();
    ~Vtb_rng_uvm_pkg__03a__03auvm_reg_cbs__Vclpkg();
    void ctor(Vtb_rng__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vtb_rng_uvm_pkg__03a__03auvm_reg_cbs__Vclpkg);
    ...
    void __VnoInFunc_get_type(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_object_registry__pi112> &get_type__Vfuncrtn);
...
class Vtb_rng_uvm_pkg__03a__03auvm_reg_cbs : public Vtb_rng_uvm_pkg__03a__03auvm_callback {
  public:

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_reg_cbs"; }
    VlClass* clone() const { return new Vtb_rng_uvm_pkg__03a__03auvm_reg_cbs(*this); }
    ...
    virtual void __VnoInFunc_decode(Vtb_rng__Syms* __restrict vlSymsp, VlQueue<QData/*63:0*/> &data);
    virtual void __VnoInFunc_encode(Vtb_rng__Syms* __restrict vlSymsp, VlQueue<QData/*63:0*/> &data);
    ...
    virtual void __VnoInFunc_post_predict(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_reg_field> fld, QData/*63:0*/ previous, QData/*63:0*/ &value, IData/*31:0*/ kind, IData/*31:0*/ path, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_reg_map> map);
