...
#ifndef VERILATED_VTB_RNG_UVM_PKG__03A__03AUVM_SQR_IF_BASE__TZ26_TBZ26__VCLPKG_H_
#define VERILATED_VTB_RNG_UVM_PKG__03A__03AUVM_SQR_IF_BASE__TZ26_TBZ26__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtb_rng_uvm_pkg__03a__03auvm_sqr_if_base__Tz26_TBz26__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vtb_rng_uvm_pkg__03a__03auvm_sqr_if_base__Tz26_TBz26__Vclpkg();
    ~Vtb_rng_uvm_pkg__03a__03auvm_sqr_if_base__Tz26_TBz26__Vclpkg();
    void ctor(Vtb_rng__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vtb_rng_uvm_pkg__03a__03auvm_sqr_if_base__Tz26_TBz26__Vclpkg);
...
class Vtb_rng_uvm_pkg__03a__03auvm_sqr_if_base__Tz26_TBz26 : public virtual VlClass {
  public:
    ...
    virtual void __VnoInFunc_item_done(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_sequence_item> t);
    ...
    virtual void __VnoInFunc_put_response(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_sequence_item> t);
  ...
  public:
    Vtb_rng_uvm_pkg__03a__03auvm_sqr_if_base__Tz26_TBz26() = default;
    void init(VlProcessRef vlProcess, Vtb_rng__Syms* __restrict vlSymsp);
    virtual std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vtb_rng_uvm_pkg__03a__03auvm_sqr_if_base__Tz26_TBz26();
};
