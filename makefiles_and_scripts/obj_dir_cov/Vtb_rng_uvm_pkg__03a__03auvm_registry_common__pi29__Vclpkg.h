...
#ifndef VERILATED_VTB_RNG_UVM_PKG__03A__03AUVM_REGISTRY_COMMON__PI29__VCLPKG_H_
#define VERILATED_VTB_RNG_UVM_PKG__03A__03AUVM_REGISTRY_COMMON__PI29__VCLPKG_H_  // guard
...
class Vtb_rng_uvm_pkg__03a__03auvm_registry_common__pi29;


class Vtb_rng__Syms;

class alignas(VL_CACHE_LINE_BYTES) Vtb_rng_uvm_pkg__03a__03auvm_registry_common__pi29__Vclpkg final {
  public:

    // DESIGN SPECIFIC STATE
    CData/*0:0*/ __PVT__m___05Finitialized;
    VlQueue<std::string> __PVT__m___05Ftype_aliases;
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_registry_common__pi29> __PVT__get__Vstatic__m_inst;
    ...
    // CONSTRUCTORS
    Vtb_rng_uvm_pkg__03a__03auvm_registry_common__pi29__Vclpkg();
    ~Vtb_rng_uvm_pkg__03a__03auvm_registry_common__pi29__Vclpkg();
    void ctor(Vtb_rng__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vtb_rng_uvm_pkg__03a__03auvm_registry_common__pi29__Vclpkg);
    ...
    void __VnoInFunc_create(Vtb_rng__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_component> parent, std::string contxt, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_comparer> &create__Vfuncrtn);
    void __VnoInFunc_get(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_registry_common__pi29> &get__Vfuncrtn);
...
class Vtb_rng_uvm_pkg__03a__03auvm_registry_common__pi29 : public virtual VlClass {
  public:

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_registry_common__pi29"; }
    VlClass* clone() const { return new Vtb_rng_uvm_pkg__03a__03auvm_registry_common__pi29(*this); }
  ...
  public:
    Vtb_rng_uvm_pkg__03a__03auvm_registry_common__pi29() = default;
    void init(Vtb_rng__Syms* __restrict vlSymsp);
    virtual std::string to_string() const;
    std::string to_string_middle() const;
    ~Vtb_rng_uvm_pkg__03a__03auvm_registry_common__pi29() {}
};
