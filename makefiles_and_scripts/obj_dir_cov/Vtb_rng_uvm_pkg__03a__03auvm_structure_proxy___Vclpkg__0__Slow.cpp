...
VL_ATTR_COLD void Vtb_rng_uvm_pkg__03a__03auvm_structure_proxy___Vclpkg___configure_coverage(Vtb_rng_uvm_pkg__03a__03auvm_structure_proxy___Vclpkg* vlSelf, bool first) {
    ...
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[18005]), first, "/home/matheus/tools/1800.2-2017-1.0/src/base/uvm_traversal.svh", 69, 12, "", "v_line/uvm_structure_proxy_", "block", "69-70");
    vlSelf->__vlCoverInsert(&(vlSymsp->__Vcoverage[18006]), first, "/home/matheus/tools/1800.2-2017-1.0/src/base/uvm_traversal.svh", 78, 30, "", "v_line/uvm_structure_proxy_", "block", "78");
}
