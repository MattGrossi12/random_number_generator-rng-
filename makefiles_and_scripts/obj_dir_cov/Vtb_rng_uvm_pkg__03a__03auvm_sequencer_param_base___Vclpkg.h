...
#ifndef VERILATED_VTB_RNG_UVM_PKG__03A__03AUVM_SEQUENCER_PARAM_BASE___VCLPKG_H_
#define VERILATED_VTB_RNG_UVM_PKG__03A__03AUVM_SEQUENCER_PARAM_BASE___VCLPKG_H_  // guard

#include "verilated.h"
#include "verilated_cov.h"
#include "verilated_timing.h"
#include "verilated_random.h"
class Vtb_rng_uvm_pkg__03a__03auvm_analysis_export__Tz26;
...
class alignas(VL_CACHE_LINE_BYTES) Vtb_rng_uvm_pkg__03a__03auvm_sequencer_param_base___Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vtb_rng_uvm_pkg__03a__03auvm_sequencer_param_base___Vclpkg();
    ~Vtb_rng_uvm_pkg__03a__03auvm_sequencer_param_base___Vclpkg();
    void ctor(Vtb_rng__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vtb_rng_uvm_pkg__03a__03auvm_sequencer_param_base___Vclpkg);
...
class Vtb_rng_uvm_pkg__03a__03auvm_sequencer_param_base_ : public Vtb_rng_uvm_pkg__03a__03auvm_sequencer_base {
  public:
    ...
    VlQueue<VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_sequence_item>> __PVT__m_last_req_buffer;
    VlQueue<VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_sequence_item>> __PVT__m_last_rsp_buffer;
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_sequencer_analysis_fifo_> __PVT__sqr_rsp_analysis_fifo;
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_analysis_export__Tz26> __PVT__rsp_export;
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_tlm_fifo__Tz26> __PVT__m_req_fifo;
    ...
    void __VnoInFunc_last_req(Vtb_rng__Syms* __restrict vlSymsp, IData/*31:0*/ n, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_sequence_item> &last_req__Vfuncrtn);
    void __VnoInFunc_last_rsp(Vtb_rng__Syms* __restrict vlSymsp, IData/*31:0*/ n, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_sequence_item> &last_rsp__Vfuncrtn);
    void __VnoInFunc_m_last_req_push_front(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_sequence_item> item);
    void __VnoInFunc_m_last_rsp_push_front(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_sequence_item> item);
    void __VnoInFunc_put_response(VlProcessRef vlProcess, Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_sequence_item> t);
  ...
  public:
    Vtb_rng_uvm_pkg__03a__03auvm_sequencer_param_base_() = default;
    ...
    virtual ~Vtb_rng_uvm_pkg__03a__03auvm_sequencer_param_base_();
};
