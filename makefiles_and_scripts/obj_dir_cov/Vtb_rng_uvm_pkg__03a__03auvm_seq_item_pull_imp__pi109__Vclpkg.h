...
#ifndef VERILATED_VTB_RNG_UVM_PKG__03A__03AUVM_SEQ_ITEM_PULL_IMP__PI109__VCLPKG_H_
#define VERILATED_VTB_RNG_UVM_PKG__03A__03AUVM_SEQ_ITEM_PULL_IMP__PI109__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtb_rng_uvm_pkg__03a__03auvm_seq_item_pull_imp__pi109__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vtb_rng_uvm_pkg__03a__03auvm_seq_item_pull_imp__pi109__Vclpkg();
    ~Vtb_rng_uvm_pkg__03a__03auvm_seq_item_pull_imp__pi109__Vclpkg();
    void ctor(Vtb_rng__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vtb_rng_uvm_pkg__03a__03auvm_seq_item_pull_imp__pi109__Vclpkg);
...
class Vtb_rng_uvm_pkg__03a__03auvm_seq_item_pull_imp__pi109 : public Vtb_rng_uvm_pkg__03a__03auvm_port_base__Tz208 {
  public:

    // DESIGN SPECIFIC STATE
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_sequencer_> __PVT__m_imp;

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_seq_item_pull_imp__pi109"; }
    VlClass* clone() const { return new Vtb_rng_uvm_pkg__03a__03auvm_seq_item_pull_imp__pi109(*this); }
  ...
  public:
    Vtb_rng_uvm_pkg__03a__03auvm_seq_item_pull_imp__pi109() = default;
    void init(VlProcessRef vlProcess, Vtb_rng__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_sequencer_> imp);
    virtual std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vtb_rng_uvm_pkg__03a__03auvm_seq_item_pull_imp__pi109();
};
