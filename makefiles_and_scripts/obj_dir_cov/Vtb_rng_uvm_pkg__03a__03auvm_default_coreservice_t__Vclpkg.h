...
#ifndef VERILATED_VTB_RNG_UVM_PKG__03A__03AUVM_DEFAULT_CORESERVICE_T__VCLPKG_H_
#define VERILATED_VTB_RNG_UVM_PKG__03A__03AUVM_DEFAULT_CORESERVICE_T__VCLPKG_H_  // guard
...
class Vtb_rng_uvm_pkg__03a__03auvm_component_name_check_visitor;
class Vtb_rng_uvm_pkg__03a__03auvm_copier;
class Vtb_rng_uvm_pkg__03a__03auvm_coreservice_t;
class Vtb_rng_uvm_pkg__03a__03auvm_default_factory;
...
class alignas(VL_CACHE_LINE_BYTES) Vtb_rng_uvm_pkg__03a__03auvm_default_coreservice_t__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vtb_rng_uvm_pkg__03a__03auvm_default_coreservice_t__Vclpkg();
    ~Vtb_rng_uvm_pkg__03a__03auvm_default_coreservice_t__Vclpkg();
    void ctor(Vtb_rng__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vtb_rng_uvm_pkg__03a__03auvm_default_coreservice_t__Vclpkg);
...
class Vtb_rng_uvm_pkg__03a__03auvm_default_coreservice_t : public Vtb_rng_uvm_pkg__03a__03auvm_coreservice_t {
  public:
    ...
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_factory> __PVT__factory;
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_tr_database> __PVT__tr_database;
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_report_server> __PVT__report_server;
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_visitor_> __PVT___visitor;
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_printer> __PVT__m_printer;
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_packer> __PVT__m_packer;
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_comparer> __PVT__m_comparer;
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_resource_pool> __PVT__m_rp;
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_copier> __PVT__m_copier;

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_default_coreservice_t"; }
    VlClass* clone() const { return new Vtb_rng_uvm_pkg__03a__03auvm_default_coreservice_t(*this); }
  ...
  public:
    Vtb_rng_uvm_pkg__03a__03auvm_default_coreservice_t() = default;
    void init(Vtb_rng__Syms* __restrict vlSymsp);
    virtual std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vtb_rng_uvm_pkg__03a__03auvm_default_coreservice_t();
};
