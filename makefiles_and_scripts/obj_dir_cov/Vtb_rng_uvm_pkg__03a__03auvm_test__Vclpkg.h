...
#ifndef VERILATED_VTB_RNG_UVM_PKG__03A__03AUVM_TEST__VCLPKG_H_
#define VERILATED_VTB_RNG_UVM_PKG__03A__03AUVM_TEST__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtb_rng_uvm_pkg__03a__03auvm_test__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vtb_rng_uvm_pkg__03a__03auvm_test__Vclpkg();
    ~Vtb_rng_uvm_pkg__03a__03auvm_test__Vclpkg();
    void ctor(Vtb_rng__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vtb_rng_uvm_pkg__03a__03auvm_test__Vclpkg);
    ...
    void __VnoInFunc_get_type(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_abstract_component_registry__pi87> &get_type__Vfuncrtn);
...
class Vtb_rng_uvm_pkg__03a__03auvm_test : public Vtb_rng_uvm_pkg__03a__03auvm_component {
  public:
  ...
  public:
    Vtb_rng_uvm_pkg__03a__03auvm_test() = default;
    ...
    virtual ~Vtb_rng_uvm_pkg__03a__03auvm_test();
};
