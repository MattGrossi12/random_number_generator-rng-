    ...
    IData/*31:0*/ n_bits;
    {
        ...
        if (__VlefLogAnd_10) {
            ...
            if ((0U != __VlefCall_11__uvm_report_enabled)) {
                ...
                ++(vlSymsp->__Vcoverage[24699]);
            }
            goto __Vlabel0;
        } else {
            ++(vlSymsp->__Vcoverage[24701]);
        }
