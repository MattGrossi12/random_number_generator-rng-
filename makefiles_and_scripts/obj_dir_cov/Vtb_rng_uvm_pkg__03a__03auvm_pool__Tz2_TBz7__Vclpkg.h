...
#ifndef VERILATED_VTB_RNG_UVM_PKG__03A__03AUVM_POOL__TZ2_TBZ7__VCLPKG_H_
#define VERILATED_VTB_RNG_UVM_PKG__03A__03AUVM_POOL__TZ2_TBZ7__VCLPKG_H_  // guard
...
class Vtb_rng_uvm_pkg__03a__03auvm_object_registry__Tz103;
class Vtb_rng_uvm_pkg__03a__03auvm_object_wrapper;
class Vtb_rng_uvm_pkg__03a__03auvm_pool__Tz2_TBz7;
...
class alignas(VL_CACHE_LINE_BYTES) Vtb_rng_uvm_pkg__03a__03auvm_pool__Tz2_TBz7__Vclpkg final {
  public:

    // DESIGN SPECIFIC STATE
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_pool__Tz2_TBz7> __PVT__m_global_pool;
    ...
    // CONSTRUCTORS
    Vtb_rng_uvm_pkg__03a__03auvm_pool__Tz2_TBz7__Vclpkg();
    ~Vtb_rng_uvm_pkg__03a__03auvm_pool__Tz2_TBz7__Vclpkg();
    void ctor(Vtb_rng__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vtb_rng_uvm_pkg__03a__03auvm_pool__Tz2_TBz7__Vclpkg);
    ...
    void __VnoInFunc_get_global(Vtb_rng__Syms* __restrict vlSymsp, std::string key, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_event_> &get_global__Vfuncrtn);
    void __VnoInFunc_get_global_pool(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_pool__Tz2_TBz7> &get_global_pool__Vfuncrtn);
    void __VnoInFunc_get_type(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_object_registry__Tz103> &get_type__Vfuncrtn);
...
class Vtb_rng_uvm_pkg__03a__03auvm_pool__Tz2_TBz7 : public Vtb_rng_uvm_pkg__03a__03auvm_object {
  public:
    ...
    VlAssocArray<std::string, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_event_>> __PVT__pool;

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_pool__Tz2_TBz7"; }
    VlClass* clone() const { return new Vtb_rng_uvm_pkg__03a__03auvm_pool__Tz2_TBz7(*this); }
    virtual void __VnoInFunc___VBasicRand(Vtb_rng__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn);
    virtual void __VnoInFunc___Vsetup_constraints(Vtb_rng__Syms* __restrict vlSymsp);
    virtual void __VnoInFunc_add(Vtb_rng__Syms* __restrict vlSymsp, std::string key, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_event_> item);
    ...
    virtual void __VnoInFunc_get(VlProcessRef vlProcess, Vtb_rng__Syms* __restrict vlSymsp, std::string key, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_event_> &get__Vfuncrtn);
  ...
  public:
    Vtb_rng_uvm_pkg__03a__03auvm_pool__Tz2_TBz7() = default;
    void init(VlProcessRef vlProcess, Vtb_rng__Syms* __restrict vlSymsp, std::string name);
    virtual std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vtb_rng_uvm_pkg__03a__03auvm_pool__Tz2_TBz7();
};
