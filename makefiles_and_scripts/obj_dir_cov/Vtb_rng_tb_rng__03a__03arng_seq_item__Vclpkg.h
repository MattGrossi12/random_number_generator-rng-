...
#ifndef VERILATED_VTB_RNG_TB_RNG__03A__03ARNG_SEQ_ITEM__VCLPKG_H_
#define VERILATED_VTB_RNG_TB_RNG__03A__03ARNG_SEQ_ITEM__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtb_rng_tb_rng__03a__03arng_seq_item__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vtb_rng_tb_rng__03a__03arng_seq_item__Vclpkg();
    ~Vtb_rng_tb_rng__03a__03arng_seq_item__Vclpkg();
    void ctor(Vtb_rng__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vtb_rng_tb_rng__03a__03arng_seq_item__Vclpkg);
    ...
    void __VnoInFunc_get_type(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_object_registry__pi62> &get_type__Vfuncrtn);
...
class Vtb_rng_tb_rng__03a__03arng_seq_item : public Vtb_rng_uvm_pkg__03a__03auvm_sequence_item {
  public:

    // DESIGN SPECIFIC STATE
    IData/*31:0*/ __PVT__round_id;
    IData/*31:0*/ __PVT__inter_req_tu;
    QData/*63:0*/ __PVT__clk_toggle_tu;

    // INTERNAL METHODS
    virtual const char* typeName() const { return "tb_rng::rng_seq_item"; }
    VlClass* clone() const { return new Vtb_rng_tb_rng__03a__03arng_seq_item(*this); }
