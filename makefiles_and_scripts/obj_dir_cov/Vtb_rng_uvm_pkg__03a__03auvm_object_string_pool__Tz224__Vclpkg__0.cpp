...
void Vtb_rng_uvm_pkg__03a__03auvm_object_string_pool__Tz224__Vclpkg::__VnoInFunc_get_type(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_object_registry__Tz268> &get_type__Vfuncrtn) {
...
void Vtb_rng_uvm_pkg__03a__03auvm_object_string_pool__Tz224__Vclpkg::__VnoInFunc_get_global_pool(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_object_string_pool__Tz224> &get_global_pool__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtb_rng_uvm_pkg__03a__03auvm_object_string_pool__Tz224__Vclpkg::__VnoInFunc_get_global_pool\n"); );
    // Body
...
void Vtb_rng_uvm_pkg__03a__03auvm_object_string_pool__Tz224__Vclpkg::__VnoInFunc_get_global(Vtb_rng__Syms* __restrict vlSymsp, std::string key, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz2> &get_global__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtb_rng_uvm_pkg__03a__03auvm_object_string_pool__Tz224__Vclpkg::__VnoInFunc_get_global\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
...
void Vtb_rng_uvm_pkg__03a__03auvm_object_string_pool__Tz224::__VnoInFunc_get_object_type(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_object_wrapper> &get_object_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_object_string_pool__Tz224::__VnoInFunc_get_object_type\n"); );
    // Locals
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_object_registry__Tz268> __Vfunc_get__0__Vfuncout;
    // Body
...
void Vtb_rng_uvm_pkg__03a__03auvm_object_string_pool__Tz224::__VnoInFunc_create(VlProcessRef vlProcess, Vtb_rng__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_object> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_object_string_pool__Tz224::__VnoInFunc_create\n"); );
    // Body
...
void Vtb_rng_uvm_pkg__03a__03auvm_object_string_pool__Tz224::init(VlProcessRef vlProcess, Vtb_rng__Syms* __restrict vlSymsp, std::string name) {
    Vtb_rng_uvm_pkg__03a__03auvm_pool__Tz2_TBz224::init(vlProcess, vlSymsp, name);
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_object_string_pool__Tz224::new\n"); );
    // Body
...
void Vtb_rng_uvm_pkg__03a__03auvm_object_string_pool__Tz224::__VnoInFunc_get(VlProcessRef vlProcess, Vtb_rng__Syms* __restrict vlSymsp, std::string key, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz2> &get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_object_string_pool__Tz224::__VnoInFunc_get\n"); );
    // Body
...
void Vtb_rng_uvm_pkg__03a__03auvm_object_string_pool__Tz224::__VnoInFunc_delete(Vtb_rng__Syms* __restrict vlSymsp, std::string key) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_object_string_pool__Tz224::__VnoInFunc_delete\n"); );
    // Locals
...
void Vtb_rng_uvm_pkg__03a__03auvm_object_string_pool__Tz224::__VnoInFunc_do_print(VlProcessRef vlProcess, Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_printer> printer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_object_string_pool__Tz224::__VnoInFunc_do_print\n"); );
    // Body
    CData/*0:0*/ __VlefExpr_1;
    CData/*0:0*/ __VlefExpr_0;
    std::string key;
    key = ""s;
    VL_NULL_CHECK(printer, "/home/matheus/tools/1800.2-2017-1.0/src/base/uvm_pool.svh", 323)->__VnoInFunc_print_array_header(vlProcess, vlSymsp, "pool"s, Vtb_rng_uvm_pkg__03a__03auvm_pool__Tz2_TBz224::__PVT__pool.size(), "aa_object_string"s, 0x2eU);
    __VlefExpr_0 = (0U != Vtb_rng_uvm_pkg__03a__03auvm_pool__Tz2_TBz224::__PVT__pool.first(key));
    if (__VlefExpr_0) {
        while (true) {
...
void Vtb_rng_uvm_pkg__03a__03auvm_object_string_pool__Tz224::__VnoInFunc_randomize(Vtb_rng__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_object_string_pool__Tz224::__VnoInFunc_randomize\n"); );
    // Body
...
void Vtb_rng_uvm_pkg__03a__03auvm_object_string_pool__Tz224::__VnoInFunc___Vsetup_constraints(Vtb_rng__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_object_string_pool__Tz224::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vtb_rng_uvm_pkg__03a__03auvm_object_string_pool__Tz224::__VnoInFunc___VBasicRand(Vtb_rng__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_object_string_pool__Tz224::__VnoInFunc___VBasicRand\n"); );
    // Body
    __VBasicRand__Vfuncrtn = 1U;
}

void Vtb_rng_uvm_pkg__03a__03auvm_object_string_pool__Tz224::_ctor_var_reset(Vtb_rng__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_object_string_pool__Tz224::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
}

Vtb_rng_uvm_pkg__03a__03auvm_object_string_pool__Tz224::~Vtb_rng_uvm_pkg__03a__03auvm_object_string_pool__Tz224() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_object_string_pool__Tz224::~\n"); );
}

std::string Vtb_rng_uvm_pkg__03a__03auvm_object_string_pool__Tz224::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_object_string_pool__Tz224::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vtb_rng_uvm_pkg__03a__03auvm_object_string_pool__Tz224::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_object_string_pool__Tz224::to_string_middle\n"); );
    // Body
    std::string out;
    out += Vtb_rng_uvm_pkg__03a__03auvm_pool__Tz2_TBz224::to_string_middle();
    return (out);
}
