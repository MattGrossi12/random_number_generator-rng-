...
#ifndef VERILATED_VTB_RNG_UVM_PKG__03A__03AUVM_RESOURCE__TZ10__VCLPKG_H_
#define VERILATED_VTB_RNG_UVM_PKG__03A__03AUVM_RESOURCE__TZ10__VCLPKG_H_  // guard
...
class Vtb_rng_uvm_pkg__03a__03auvm_object_registry__Tz64;
...
class alignas(VL_CACHE_LINE_BYTES) Vtb_rng_uvm_pkg__03a__03auvm_resource__Tz10__Vclpkg final {
  public:

    // DESIGN SPECIFIC STATE
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_resource__Tz10> __PVT__my_type;
    ...
    // CONSTRUCTORS
    Vtb_rng_uvm_pkg__03a__03auvm_resource__Tz10__Vclpkg();
    ~Vtb_rng_uvm_pkg__03a__03auvm_resource__Tz10__Vclpkg();
    void ctor(Vtb_rng__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vtb_rng_uvm_pkg__03a__03auvm_resource__Tz10__Vclpkg);
    ...
    void __VnoInFunc_get_highest_precedence(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz5> &q, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_resource__Tz10> &get_highest_precedence__Vfuncrtn);
    void __VnoInFunc_get_type(VlProcessRef vlProcess, Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_resource__Tz10> &get_type__Vfuncrtn);
...
class Vtb_rng_uvm_pkg__03a__03auvm_resource__Tz10 : public Vtb_rng_uvm_pkg__03a__03auvm_resource_base {
  public:
    ...
    VlClass* clone() const { return new Vtb_rng_uvm_pkg__03a__03auvm_resource__Tz10(*this); }
    ...
    void __VnoInFunc_read(VlProcessRef vlProcess, Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_object> accessor, IData/*31:0*/ &read__Vfuncrtn);
  ...
  public:
    Vtb_rng_uvm_pkg__03a__03auvm_resource__Tz10() = default;
    void init(VlProcessRef vlProcess, Vtb_rng__Syms* __restrict vlSymsp, std::string name);
    virtual std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vtb_rng_uvm_pkg__03a__03auvm_resource__Tz10();
};
