...
void Vtb_rng_uvm_pkg__03a__03auvm_analysis_port__Tz10::init(VlProcessRef vlProcess, Vtb_rng__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_component> parent) {
    Vtb_rng_uvm_pkg__03a__03auvm_port_base__Tz152::init(vlProcess, vlSymsp, name, parent, 0U, 0U, vlSymsp->TOP__uvm_pkg.__PVT__UVM_UNBOUNDED_CONNECTIONS);
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtb_rng_uvm_pkg__03a__03auvm_analysis_port__Tz10::new\n"); );
    // Body
...
void Vtb_rng_uvm_pkg__03a__03auvm_analysis_port__Tz10::__VnoInFunc_write(VlProcessRef vlProcess, Vtb_rng__Syms* __restrict vlSymsp, IData/*31:0*/ t) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtb_rng_uvm_pkg__03a__03auvm_analysis_port__Tz10::__VnoInFunc_write\n"); );
    // Locals
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_port_base__Tz152> __Vfunc_get_if__2__Vfuncout;
    // Body
    std::string __VlefCall_1__get_full_name;
    IData/*31:0*/ __VlefCall_0__size;
    IData/*31:0*/ unnamedblk1__DOT__i;
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_tlm_if_base__Tz10_TBz10> tif;
...
void Vtb_rng_uvm_pkg__03a__03auvm_analysis_port__Tz10::_ctor_var_reset(Vtb_rng__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtb_rng_uvm_pkg__03a__03auvm_analysis_port__Tz10::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
}

Vtb_rng_uvm_pkg__03a__03auvm_analysis_port__Tz10::~Vtb_rng_uvm_pkg__03a__03auvm_analysis_port__Tz10() {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtb_rng_uvm_pkg__03a__03auvm_analysis_port__Tz10::~\n"); );
}

std::string Vtb_rng_uvm_pkg__03a__03auvm_analysis_port__Tz10::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtb_rng_uvm_pkg__03a__03auvm_analysis_port__Tz10::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vtb_rng_uvm_pkg__03a__03auvm_analysis_port__Tz10::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtb_rng_uvm_pkg__03a__03auvm_analysis_port__Tz10::to_string_middle\n"); );
    // Body
    std::string out;
