...
void Vtb_rng_uvm_pkg__03a__03auvm_set_before_get_dap__Tz21__Vclpkg::__VnoInFunc_get_type(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_object_registry__Tz74> &get_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtb_rng_uvm_pkg__03a__03auvm_set_before_get_dap__Tz21__Vclpkg::__VnoInFunc_get_type\n"); );
    // Body
    vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__Tz74__Vclpkg.__VnoInFunc_get(vlSymsp, get_type__Vfuncrtn);
    ++(vlSymsp->__Vcoverage[17914]);
}

void Vtb_rng_uvm_pkg__03a__03auvm_set_before_get_dap__Tz21::__VnoInFunc_get_object_type(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_object_wrapper> &get_object_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_set_before_get_dap__Tz21::__VnoInFunc_get_object_type\n"); );
    // Locals
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_object_registry__Tz74> __Vfunc_get__0__Vfuncout;
    // Body
...
void Vtb_rng_uvm_pkg__03a__03auvm_set_before_get_dap__Tz21::__VnoInFunc_create(VlProcessRef vlProcess, Vtb_rng__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_object> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_set_before_get_dap__Tz21::__VnoInFunc_create\n"); );
    // Body
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_set_before_get_dap__Tz21> tmp;
    if ((""s == name)) {
        tmp = VL_NEW(Vtb_rng_uvm_pkg__03a__03auvm_set_before_get_dap__Tz21, vlProcess, vlSymsp, "unnamed-uvm_set_before_get_dap#(T)"s);
        ++(vlSymsp->__Vcoverage[17916]);
    } else {
        tmp = VL_NEW(Vtb_rng_uvm_pkg__03a__03auvm_set_before_get_dap__Tz21, vlProcess, vlSymsp, name);
...
void Vtb_rng_uvm_pkg__03a__03auvm_set_before_get_dap__Tz21::init(VlProcessRef vlProcess, Vtb_rng__Syms* __restrict vlSymsp, std::string name) {
    Vtb_rng_uvm_pkg__03a__03auvm_set_get_dap_base__Tz21::init(vlProcess, vlSymsp, name);
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_set_before_get_dap__Tz21::new\n"); );
    // Body
...
void Vtb_rng_uvm_pkg__03a__03auvm_set_before_get_dap__Tz21::__VnoInFunc_set(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_tr_stream> value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_set_before_get_dap__Tz21::__VnoInFunc_set\n"); );
    // Body
...
void Vtb_rng_uvm_pkg__03a__03auvm_set_before_get_dap__Tz21::__VnoInFunc_try_set(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_tr_stream> value, CData/*0:0*/ &try_set__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_set_before_get_dap__Tz21::__VnoInFunc_try_set\n"); );
    // Body
...
void Vtb_rng_uvm_pkg__03a__03auvm_set_before_get_dap__Tz21::__VnoInFunc_get(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_tr_stream> &get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_set_before_get_dap__Tz21::__VnoInFunc_get\n"); );
    // Locals
...
void Vtb_rng_uvm_pkg__03a__03auvm_set_before_get_dap__Tz21::__VnoInFunc_try_get(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_tr_stream> &value, CData/*0:0*/ &try_get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_set_before_get_dap__Tz21::__VnoInFunc_try_get\n"); );
    // Body
    if (this->__PVT__m_set) {
...
void Vtb_rng_uvm_pkg__03a__03auvm_set_before_get_dap__Tz21::__VnoInFunc_do_copy(VlProcessRef vlProcess, Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_object> rhs) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_set_before_get_dap__Tz21::__VnoInFunc_do_copy\n"); );
    // Locals
...
void Vtb_rng_uvm_pkg__03a__03auvm_set_before_get_dap__Tz21::__VnoInFunc_do_pack(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_packer> packer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_set_before_get_dap__Tz21::__VnoInFunc_do_pack\n"); );
    // Locals
...
void Vtb_rng_uvm_pkg__03a__03auvm_set_before_get_dap__Tz21::__VnoInFunc_do_unpack(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_packer> packer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_set_before_get_dap__Tz21::__VnoInFunc_do_unpack\n"); );
    // Locals
...
void Vtb_rng_uvm_pkg__03a__03auvm_set_before_get_dap__Tz21::__VnoInFunc_convert2string(VlProcessRef vlProcess, Vtb_rng__Syms* __restrict vlSymsp, std::string &convert2string__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_set_before_get_dap__Tz21::__VnoInFunc_convert2string\n"); );
    // Locals
...
void Vtb_rng_uvm_pkg__03a__03auvm_set_before_get_dap__Tz21::__VnoInFunc_do_print(VlProcessRef vlProcess, Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_printer> printer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_set_before_get_dap__Tz21::__VnoInFunc_do_print\n"); );
    // Locals
    std::string __Vtemp_1;
    // Body
...
void Vtb_rng_uvm_pkg__03a__03auvm_set_before_get_dap__Tz21::__VnoInFunc_randomize(Vtb_rng__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_set_before_get_dap__Tz21::__VnoInFunc_randomize\n"); );
    // Body
...
void Vtb_rng_uvm_pkg__03a__03auvm_set_before_get_dap__Tz21::__VnoInFunc___Vsetup_constraints(Vtb_rng__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_set_before_get_dap__Tz21::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vtb_rng_uvm_pkg__03a__03auvm_set_before_get_dap__Tz21::__VnoInFunc___VBasicRand(Vtb_rng__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_set_before_get_dap__Tz21::__VnoInFunc___VBasicRand\n"); );
    // Body
    __VBasicRand__Vfuncrtn = 1U;
}

void Vtb_rng_uvm_pkg__03a__03auvm_set_before_get_dap__Tz21::_ctor_var_reset(Vtb_rng__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_set_before_get_dap__Tz21::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
    __PVT__m_set = 0;
}

Vtb_rng_uvm_pkg__03a__03auvm_set_before_get_dap__Tz21::~Vtb_rng_uvm_pkg__03a__03auvm_set_before_get_dap__Tz21() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_set_before_get_dap__Tz21::~\n"); );
}

std::string Vtb_rng_uvm_pkg__03a__03auvm_set_before_get_dap__Tz21::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_set_before_get_dap__Tz21::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vtb_rng_uvm_pkg__03a__03auvm_set_before_get_dap__Tz21::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_set_before_get_dap__Tz21::to_string_middle\n"); );
    // Body
    std::string out;
    out += "m_value:" + VL_TO_STRING(__PVT__m_value);
    out += ", m_set:" + VL_TO_STRING(__PVT__m_set);
    out += ", " + Vtb_rng_uvm_pkg__03a__03auvm_set_get_dap_base__Tz21::to_string_middle();
    return (out);
}
