...
#ifndef VERILATED_VTB_RNG_UVM_PKG__03A__03AUVM_TOPDOWN_PHASE__VCLPKG_H_
#define VERILATED_VTB_RNG_UVM_PKG__03A__03AUVM_TOPDOWN_PHASE__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtb_rng_uvm_pkg__03a__03auvm_topdown_phase__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vtb_rng_uvm_pkg__03a__03auvm_topdown_phase__Vclpkg();
    ~Vtb_rng_uvm_pkg__03a__03auvm_topdown_phase__Vclpkg();
    void ctor(Vtb_rng__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vtb_rng_uvm_pkg__03a__03auvm_topdown_phase__Vclpkg);
...
class Vtb_rng_uvm_pkg__03a__03auvm_topdown_phase : public Vtb_rng_uvm_pkg__03a__03auvm_phase {
  public:
    ...
    std::string __Vfunc_uvm_create_random_seed__34__type_id;
    std::string __Vfunc_uvm_create_random_seed__34__inst_id;
    std::string __Vfunc_uvm_create_random_seed__34____VlefCall_1__uvm_instance_scope;
  ...
  public:
    Vtb_rng_uvm_pkg__03a__03auvm_topdown_phase() = default;
    void init(VlProcessRef vlProcess, Vtb_rng__Syms* __restrict vlSymsp, std::string name);
    virtual std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vtb_rng_uvm_pkg__03a__03auvm_topdown_phase();
};
