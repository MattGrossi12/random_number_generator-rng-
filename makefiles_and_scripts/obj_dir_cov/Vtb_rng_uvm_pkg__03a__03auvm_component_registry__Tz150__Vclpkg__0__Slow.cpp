...
VL_ATTR_COLD void Vtb_rng_uvm_pkg__03a__03auvm_component_registry__Tz150__Vclpkg___eval_static__TOP__uvm_pkg__03a__03auvm_component_registry__Tz150__Vclpkg(Vtb_rng_uvm_pkg__03a__03auvm_component_registry__Tz150__Vclpkg* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtb_rng_uvm_pkg__03a__03auvm_component_registry__Tz150__Vclpkg___eval_static__TOP__uvm_pkg__03a__03auvm_component_registry__Tz150__Vclpkg\n"); );
    Vtb_rng__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
}

VL_ATTR_COLD void Vtb_rng_uvm_pkg__03a__03auvm_component_registry__Tz150__Vclpkg___ctor_var_reset(Vtb_rng_uvm_pkg__03a__03auvm_component_registry__Tz150__Vclpkg* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtb_rng_uvm_pkg__03a__03auvm_component_registry__Tz150__Vclpkg___ctor_var_reset\n"); );
    Vtb_rng__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
}

VL_ATTR_COLD void Vtb_rng_uvm_pkg__03a__03auvm_component_registry__Tz150__Vclpkg___configure_coverage(Vtb_rng_uvm_pkg__03a__03auvm_component_registry__Tz150__Vclpkg* vlSelf, bool first) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtb_rng_uvm_pkg__03a__03auvm_component_registry__Tz150__Vclpkg___configure_coverage\n"); );
    Vtb_rng__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vtb_rng_uvm_pkg__03a__03auvm_component_registry__Tz150___configure_coverage(Vtb_rng_uvm_pkg__03a__03auvm_component_registry__Tz150* vlSelf, bool first) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_component_registry__Tz150___configure_coverage\n"); );
