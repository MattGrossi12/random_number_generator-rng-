...
void Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz212__Vclpkg::__VnoInFunc_get_type(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_object_registry__Tz213> &get_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz212__Vclpkg::__VnoInFunc_get_type\n"); );
    // Body
    vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__Tz213__Vclpkg.__VnoInFunc_get(vlSymsp, get_type__Vfuncrtn);
    ++(vlSymsp->__Vcoverage[9151]);
}

void Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz212__Vclpkg::__VnoInFunc_type_name(Vtb_rng__Syms* __restrict vlSymsp, std::string &type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz212__Vclpkg::__VnoInFunc_type_name\n"); );
    // Body
    type_name__Vfuncrtn = "uvm_queue"s;
    ++(vlSymsp->__Vcoverage[9156]);
}

void Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz212__Vclpkg::__VnoInFunc_get_global_queue(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz212> &get_global_queue__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz212__Vclpkg::__VnoInFunc_get_global_queue\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    if ((VlNull{} == this->__PVT__m_global_queue)) {
        this->__PVT__m_global_queue = VL_NEW(Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz212, vlProcess, vlSymsp, "global_queue"s);
...
void Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz212__Vclpkg::__VnoInFunc_get_global(Vtb_rng__Syms* __restrict vlSymsp, IData/*31:0*/ index, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_hdl_path_concat> &get_global__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz212__Vclpkg::__VnoInFunc_get_global\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz212> gqueue;
...
void Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz212::__VnoInFunc_get_object_type(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_object_wrapper> &get_object_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz212::__VnoInFunc_get_object_type\n"); );
    // Locals
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_object_registry__Tz213> __Vfunc_get__0__Vfuncout;
    // Body
    vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__Tz213__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__0__Vfuncout);
    get_object_type__Vfuncrtn = __Vfunc_get__0__Vfuncout;
    ++(vlSymsp->__Vcoverage[9152]);
}

void Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz212::__VnoInFunc_create(VlProcessRef vlProcess, Vtb_rng__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_object> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz212::__VnoInFunc_create\n"); );
    // Body
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz212> tmp;
    if ((""s == name)) {
        tmp = VL_NEW(Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz212, vlProcess, vlSymsp, ""s);
        ++(vlSymsp->__Vcoverage[9153]);
    } else {
        tmp = VL_NEW(Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz212, vlProcess, vlSymsp, name);
...
void Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz212::__VnoInFunc_get_type_name(Vtb_rng__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz212::__VnoInFunc_get_type_name\n"); );
    // Body
    get_type_name__Vfuncrtn = "uvm_queue"s;
    ++(vlSymsp->__Vcoverage[9157]);
}

void Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz212::init(VlProcessRef vlProcess, Vtb_rng__Syms* __restrict vlSymsp, std::string name) {
    Vtb_rng_uvm_pkg__03a__03auvm_object::init(vlProcess, vlSymsp, name);
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz212::new\n"); );
    // Body
...
void Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz212::__VnoInFunc_get(VlProcessRef vlProcess, Vtb_rng__Syms* __restrict vlSymsp, IData/*31:0*/ index, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_hdl_path_concat> &get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz212::__VnoInFunc_get\n"); );
    // Locals
    ...
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_hdl_path_concat> default_value;
    {
...
void Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz212::__VnoInFunc_size(Vtb_rng__Syms* __restrict vlSymsp, IData/*31:0*/ &size__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz212::__VnoInFunc_size\n"); );
    // Body
    size__Vfuncrtn = this->__PVT__queue.size();
    ++(vlSymsp->__Vcoverage[9169]);
}

void Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz212::__VnoInFunc_insert(Vtb_rng__Syms* __restrict vlSymsp, IData/*31:0*/ index, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_hdl_path_concat> item) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz212::__VnoInFunc_insert\n"); );
    // Locals
...
void Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz212::__VnoInFunc_delete(Vtb_rng__Syms* __restrict vlSymsp, IData/*31:0*/ index) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz212::__VnoInFunc_delete\n"); );
    // Locals
...
void Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz212::__VnoInFunc_pop_front(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_hdl_path_concat> &pop_front__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz212::__VnoInFunc_pop_front\n"); );
    // Body
    pop_front__Vfuncrtn = this->__PVT__queue.pop_front();
    ++(vlSymsp->__Vcoverage[9184]);
}

void Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz212::__VnoInFunc_pop_back(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_hdl_path_concat> &pop_back__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz212::__VnoInFunc_pop_back\n"); );
    // Body
    pop_back__Vfuncrtn = this->__PVT__queue.pop_back();
    ++(vlSymsp->__Vcoverage[9185]);
}

void Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz212::__VnoInFunc_push_front(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_hdl_path_concat> item) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz212::__VnoInFunc_push_front\n"); );
    // Body
    this->__PVT__queue.push_front(item);
    ++(vlSymsp->__Vcoverage[9186]);
}

void Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz212::__VnoInFunc_push_back(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_hdl_path_concat> item) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz212::__VnoInFunc_push_back\n"); );
    // Body
    this->__PVT__queue.push_back(item);
    ++(vlSymsp->__Vcoverage[9187]);
}

VlCoroutine Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz212::__VnoInFunc_wait_until_not_empty(Vtb_rng__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz212::__VnoInFunc_wait_until_not_empty\n"); );
    // Locals
    CData/*0:0*/ __Vtrigprevexpr_hdcbd94a4__0;
    __Vtrigprevexpr_hdcbd94a4__0 = 0;
    // Body
    VL_KEEP_THIS;
    if (VL_GTES_III(32, 0U, this->__PVT__queue.size())) {
        CData/*0:0*/ __VdynTrigger_he6c16050__0;
        __VdynTrigger_he6c16050__0 = 0;
        __VdynTrigger_he6c16050__0 = 0U;
        while ((1U & (~ (IData)(__VdynTrigger_he6c16050__0)))) {
            co_await vlSymsp->TOP.__VdynSched.evaluation(
                                                         nullptr, 
                                                         "@([true] (32'sh0 < uvm_pkg::uvm_queue__Tz212.queue.size()))", 
                                                         "/home/matheus/tools/1800.2-2017-1.0/src/base/uvm_queue.svh", 
                                                         196);
            __Vtrigprevexpr_hdcbd94a4__0 = VL_LTS_III(32, 0U, this->__PVT__queue.size());
            __VdynTrigger_he6c16050__0 = __Vtrigprevexpr_hdcbd94a4__0;
            vlSymsp->TOP.__VdynSched.anyTriggered(__VdynTrigger_he6c16050__0);
        }
...
void Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz212::__VnoInFunc_do_copy(VlProcessRef vlProcess, Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_object> rhs) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz212::__VnoInFunc_do_copy\n"); );
    // Body
    CData/*0:0*/ __VlefLogOr_1;
    IData/*31:0*/ __VlefExpr_0;
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz212> p;
    {
...
void Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz212::__VnoInFunc_convert2string(VlProcessRef vlProcess, Vtb_rng__Syms* __restrict vlSymsp, std::string &convert2string__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz212::__VnoInFunc_convert2string\n"); );
    // Locals
...
void Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz212::__VnoInFunc_randomize(Vtb_rng__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz212::__VnoInFunc_randomize\n"); );
    // Body
...
void Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz212::__VnoInFunc___Vsetup_constraints(Vtb_rng__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz212::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz212::__VnoInFunc___VBasicRand(Vtb_rng__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz212::__VnoInFunc___VBasicRand\n"); );
    // Body
    __VBasicRand__Vfuncrtn = 1U;
}

void Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz212::_ctor_var_reset(Vtb_rng__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz212::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
}

Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz212::~Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz212() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz212::~\n"); );
}

std::string Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz212::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz212::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz212::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_queue__Tz212::to_string_middle\n"); );
    // Body
    std::string out;
