...
#ifndef VERILATED_VTB_RNG_UVM_PKG__03A__03AUVM_TLM_IF_BASE__TZ126_TBZ126__VCLPKG_H_
#define VERILATED_VTB_RNG_UVM_PKG__03A__03AUVM_TLM_IF_BASE__TZ126_TBZ126__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtb_rng_uvm_pkg__03a__03auvm_tlm_if_base__Tz126_TBz126__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vtb_rng_uvm_pkg__03a__03auvm_tlm_if_base__Tz126_TBz126__Vclpkg();
    ~Vtb_rng_uvm_pkg__03a__03auvm_tlm_if_base__Tz126_TBz126__Vclpkg();
    void ctor(Vtb_rng__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vtb_rng_uvm_pkg__03a__03auvm_tlm_if_base__Tz126_TBz126__Vclpkg);
...
class Vtb_rng_uvm_pkg__03a__03auvm_tlm_if_base__Tz126_TBz126 : public virtual VlClass {
  public:
    ...
    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_tlm_if_base__Tz126_TBz126"; }
    ...
    virtual void __VnoInFunc_nb_transport(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_tb_rng__03a__03arng_seq_item> req, VlClassRef<Vtb_rng_tb_rng__03a__03arng_seq_item> &rsp, CData/*0:0*/ &nb_transport__Vfuncrtn);
    virtual VlCoroutine __VnoInFunc_peek(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_tb_rng__03a__03arng_seq_item> &t);
    virtual VlCoroutine __VnoInFunc_put(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_tb_rng__03a__03arng_seq_item> t);
    virtual void __VnoInFunc_transport(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_tb_rng__03a__03arng_seq_item> req, VlClassRef<Vtb_rng_tb_rng__03a__03arng_seq_item> &rsp);
    virtual void __VnoInFunc_try_get(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_tb_rng__03a__03arng_seq_item> &t, CData/*0:0*/ &try_get__Vfuncrtn);
    ...
    virtual void __VnoInFunc_try_put(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_tb_rng__03a__03arng_seq_item> t, CData/*0:0*/ &try_put__Vfuncrtn);
    virtual void __VnoInFunc_write(VlProcessRef vlProcess, Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_tb_rng__03a__03arng_seq_item> t);
  private:
    void _ctor_var_reset(Vtb_rng__Syms* __restrict vlSymsp);
  public:
    Vtb_rng_uvm_pkg__03a__03auvm_tlm_if_base__Tz126_TBz126() = default;
    void init(VlProcessRef vlProcess, Vtb_rng__Syms* __restrict vlSymsp);
    virtual std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vtb_rng_uvm_pkg__03a__03auvm_tlm_if_base__Tz126_TBz126();
};
