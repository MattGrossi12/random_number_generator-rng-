...
void Vtb_rng_uvm_pkg__03a__03auvm_analysis_export__Tz26::init(VlProcessRef vlProcess, Vtb_rng__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_component> parent) {
    Vtb_rng_uvm_pkg__03a__03auvm_port_base__Tz253::init(vlProcess, vlSymsp, name, parent, 1U, 1U, vlSymsp->TOP__uvm_pkg.__PVT__UVM_UNBOUNDED_CONNECTIONS);
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_analysis_export__Tz26::new\n"); );
    // Body
...
void Vtb_rng_uvm_pkg__03a__03auvm_analysis_export__Tz26::__VnoInFunc_write(VlProcessRef vlProcess, Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_sequence_item> t) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_analysis_export__Tz26::__VnoInFunc_write\n"); );
    // Locals
...
void Vtb_rng_uvm_pkg__03a__03auvm_analysis_export__Tz26::_ctor_var_reset(Vtb_rng__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_analysis_export__Tz26::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
}

Vtb_rng_uvm_pkg__03a__03auvm_analysis_export__Tz26::~Vtb_rng_uvm_pkg__03a__03auvm_analysis_export__Tz26() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_analysis_export__Tz26::~\n"); );
}

std::string Vtb_rng_uvm_pkg__03a__03auvm_analysis_export__Tz26::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_analysis_export__Tz26::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vtb_rng_uvm_pkg__03a__03auvm_analysis_export__Tz26::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_analysis_export__Tz26::to_string_middle\n"); );
    // Body
    std::string out;
