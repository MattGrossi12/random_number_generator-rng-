...
#ifndef VERILATED_VTB_RNG_UVM_PKG__03A__03AUVM_AGENT__VCLPKG_H_
#define VERILATED_VTB_RNG_UVM_PKG__03A__03AUVM_AGENT__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtb_rng_uvm_pkg__03a__03auvm_agent__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vtb_rng_uvm_pkg__03a__03auvm_agent__Vclpkg();
    ~Vtb_rng_uvm_pkg__03a__03auvm_agent__Vclpkg();
    void ctor(Vtb_rng__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vtb_rng_uvm_pkg__03a__03auvm_agent__Vclpkg);
    ...
    void __VnoInFunc_get_type(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_abstract_component_registry__pi83> &get_type__Vfuncrtn);
...
class Vtb_rng_uvm_pkg__03a__03auvm_agent : public Vtb_rng_uvm_pkg__03a__03auvm_component {
  public:
    ...
    virtual void __VnoInFunc_get_is_active(Vtb_rng__Syms* __restrict vlSymsp, CData/*0:0*/ &get_is_active__Vfuncrtn);
  ...
  public:
    Vtb_rng_uvm_pkg__03a__03auvm_agent() = default;
    ...
    virtual ~Vtb_rng_uvm_pkg__03a__03auvm_agent();
};
