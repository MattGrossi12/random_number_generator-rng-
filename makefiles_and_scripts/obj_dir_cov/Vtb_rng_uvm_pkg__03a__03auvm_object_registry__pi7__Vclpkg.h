...
#ifndef VERILATED_VTB_RNG_UVM_PKG__03A__03AUVM_OBJECT_REGISTRY__PI7__VCLPKG_H_
#define VERILATED_VTB_RNG_UVM_PKG__03A__03AUVM_OBJECT_REGISTRY__PI7__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtb_rng_uvm_pkg__03a__03auvm_object_registry__pi7__Vclpkg final {
  public:

    // DESIGN SPECIFIC STATE
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_object_registry__pi7> __PVT__get__Vstatic__m_inst;
    ...
    // CONSTRUCTORS
    Vtb_rng_uvm_pkg__03a__03auvm_object_registry__pi7__Vclpkg();
    ~Vtb_rng_uvm_pkg__03a__03auvm_object_registry__pi7__Vclpkg();
    void ctor(Vtb_rng__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vtb_rng_uvm_pkg__03a__03auvm_object_registry__pi7__Vclpkg);
    ...
    void __VnoInFunc_get(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_object_registry__pi7> &get__Vfuncrtn);
...
class Vtb_rng_uvm_pkg__03a__03auvm_object_registry__pi7 : public Vtb_rng_uvm_pkg__03a__03auvm_object_wrapper {
  public:

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_object_registry__pi7"; }
    VlClass* clone() const { return new Vtb_rng_uvm_pkg__03a__03auvm_object_registry__pi7(*this); }
  ...
  public:
    Vtb_rng_uvm_pkg__03a__03auvm_object_registry__pi7() = default;
    void init(Vtb_rng__Syms* __restrict vlSymsp);
    virtual std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vtb_rng_uvm_pkg__03a__03auvm_object_registry__pi7();
};
