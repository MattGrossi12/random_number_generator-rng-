...
#ifndef VERILATED_VTB_RNG_UVM_PKG__03A__03AUVM_REG_READ_ONLY_CBS__VCLPKG_H_
#define VERILATED_VTB_RNG_UVM_PKG__03A__03AUVM_REG_READ_ONLY_CBS__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtb_rng_uvm_pkg__03a__03auvm_reg_read_only_cbs__Vclpkg final {
  public:

    // DESIGN SPECIFIC STATE
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_reg_read_only_cbs> __PVT__m_me;
    ...
    // CONSTRUCTORS
    Vtb_rng_uvm_pkg__03a__03auvm_reg_read_only_cbs__Vclpkg();
    ~Vtb_rng_uvm_pkg__03a__03auvm_reg_read_only_cbs__Vclpkg();
    void ctor(Vtb_rng__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vtb_rng_uvm_pkg__03a__03auvm_reg_read_only_cbs__Vclpkg);
    ...
    void __VnoInFunc_get(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_reg_read_only_cbs> &get__Vfuncrtn);
    void __VnoInFunc_get_type(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_object_registry__pi181> &get_type__Vfuncrtn);
...
class Vtb_rng_uvm_pkg__03a__03auvm_reg_read_only_cbs : public Vtb_rng_uvm_pkg__03a__03auvm_reg_cbs {
  public:
    ...
    VlClass* clone() const { return new Vtb_rng_uvm_pkg__03a__03auvm_reg_read_only_cbs(*this); }
  ...
  public:
    Vtb_rng_uvm_pkg__03a__03auvm_reg_read_only_cbs() = default;
    void init(VlProcessRef vlProcess, Vtb_rng__Syms* __restrict vlSymsp, std::string name);
    virtual std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vtb_rng_uvm_pkg__03a__03auvm_reg_read_only_cbs();
};
