...
void Vtb_rng_uvm_pkg__03a__03auvm_config_db__Tz28__Vclpkg::__VnoInFunc_get(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_component> cntxt, std::string inst_name, std::string field_name, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_sequence_base> &value, CData/*0:0*/ &get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtb_rng_uvm_pkg__03a__03auvm_config_db__Tz28__Vclpkg::__VnoInFunc_get\n"); );
    // Locals
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_root> __Vtask_get_root__2__Vfuncout;
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_resource__Tz28> __Vfunc_get_highest_precedence__8__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    CData/*0:0*/ __VlefCall_3__is_tracing;
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_resource__Tz28> __VlefCall_2__get_type;
    ...
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_coreservice_t> cs;
    {
        ...
        vlSymsp->TOP__uvm_pkg__03a__03auvm_resource__Tz28__Vclpkg.__VnoInFunc_get_type(vlProcess, vlSymsp, __VlefCall_2__get_type);
        ...
        vlSymsp->TOP__uvm_pkg__03a__03auvm_resource__Tz28__Vclpkg.__VnoInFunc_get_highest_precedence(vlSymsp, rq, __Vfunc_get_highest_precedence__8__Vfuncout);
        ...
        if (__VlefCall_3__is_tracing) {
            vlSymsp->TOP__uvm_pkg__03a__03auvm_resource_db__Tz28__Vclpkg.__VnoInFunc_m_show_msg(vlSymsp, "CFGDB/GET"s, "Configuration"s, "read"s, inst_name, field_name, cntxt, r);
...
void Vtb_rng_uvm_pkg__03a__03auvm_config_db__Tz28__Vclpkg::__VnoInFunc_set(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_component> cntxt, std::string inst_name, std::string field_name, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_sequence_base> value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtb_rng_uvm_pkg__03a__03auvm_config_db__Tz28__Vclpkg::__VnoInFunc_set\n"); );
    // Locals
    ...
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_pool__Tz2_TBz90> __VlefCall_2__new;
    std::string __VlefCall_1__get_full_name;
    std::string __VlefCall_0__get_full_name;
    ...
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_resource__Tz28> r;
    std::string lookup;
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_pool__Tz2_TBz90> pool;
    std::string rstate;
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_coreservice_t> cs;
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_resource_pool> rp;
    ...
    if (this->__PVT__m_rsc.exists(cntxt)) {
        ...
        __VlefCall_2__new = VL_NEW(Vtb_rng_uvm_pkg__03a__03auvm_pool__Tz2_TBz90, vlProcess, vlSymsp, ""s);
    ...
    if ((0U != __VlefCall_3__exists)) {
        ...
        r = VL_NEW(Vtb_rng_uvm_pkg__03a__03auvm_resource__Tz28, vlProcess, vlSymsp, field_name);
    ...
    if (__VlefCall_10__is_tracing) {
        vlSymsp->TOP__uvm_pkg__03a__03auvm_resource_db__Tz28__Vclpkg.__VnoInFunc_m_show_msg(vlSymsp, "CFGDB/SET"s, "Configuration"s, "set"s, inst_name, field_name, cntxt, r);
...
void Vtb_rng_uvm_pkg__03a__03auvm_config_db__Tz28__Vclpkg::__VnoInFunc_exists(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_component> cntxt, std::string inst_name, std::string field_name, CData/*0:0*/ spell_chk, CData/*0:0*/ &exists__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtb_rng_uvm_pkg__03a__03auvm_config_db__Tz28__Vclpkg::__VnoInFunc_exists\n"); );
    // Locals
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_root> __Vtask_get_root__42__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_resource__Tz28> __VlefCall_2__get_by_name;
    std::string __VlefCall_1__get_full_name;
    std::string __VlefCall_0__get_full_name;
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_coreservice_t> cs;
    exists__Vfuncrtn = 0U;
    ...
    vlSymsp->TOP__uvm_pkg__03a__03auvm_resource_db__Tz28__Vclpkg.__VnoInFunc_get_by_name(vlSymsp, inst_name, field_name, (IData)(spell_chk), __VlefCall_2__get_by_name);
    exists__Vfuncrtn = (VlNull{} != __VlefCall_2__get_by_name);
    ++(vlSymsp->__Vcoverage[8236]);
}

VlCoroutine Vtb_rng_uvm_pkg__03a__03auvm_config_db__Tz28__Vclpkg::__VnoInFunc_wait_modified(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_component> cntxt, std::string inst_name, std::string field_name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtb_rng_uvm_pkg__03a__03auvm_config_db__Tz28__Vclpkg::__VnoInFunc_wait_modified\n"); );
    // Locals
    ...
    CData/*0:0*/ __VdynTrigger_hffd28f4e__0;
    __VdynTrigger_hffd28f4e__0 = 0;
    __VdynTrigger_hffd28f4e__0 = 0U;
    while ((1U & (~ (IData)(__VdynTrigger_hffd28f4e__0)))) {
        co_await vlSymsp->TOP.__VdynSched.evaluation(
                                                     vlProcess, 
                                                     "@([event] uvm_pkg::uvm_config_db__Tz28__Vclpkg.waiter.trigger)", 
                                                     "/home/matheus/tools/1800.2-2017-1.0/src/base/uvm_config_db.svh", 
                                                     289);
        __VdynTrigger_hffd28f4e__0 = ((VlNull{} != waiter) 
                                      && VL_NULL_CHECK(waiter, "/home/matheus/tools/1800.2-2017-1.0/src/base/uvm_config_db.svh", 289)
                                      ->__PVT__trigger.isFired());
        vlSymsp->TOP.__VdynSched.anyTriggered(__VdynTrigger_hffd28f4e__0);
...
void Vtb_rng_uvm_pkg__03a__03auvm_config_db__Tz28::init(Vtb_rng__Syms* __restrict vlSymsp) {
    Vtb_rng_uvm_pkg__03a__03auvm_resource_db__Tz28::init(vlSymsp);
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtb_rng_uvm_pkg__03a__03auvm_config_db__Tz28::new\n"); );
    // Body
...
void Vtb_rng_uvm_pkg__03a__03auvm_config_db__Tz28::_ctor_var_reset(Vtb_rng__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtb_rng_uvm_pkg__03a__03auvm_config_db__Tz28::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
}

Vtb_rng_uvm_pkg__03a__03auvm_config_db__Tz28::~Vtb_rng_uvm_pkg__03a__03auvm_config_db__Tz28() {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtb_rng_uvm_pkg__03a__03auvm_config_db__Tz28::~\n"); );
}

std::string Vtb_rng_uvm_pkg__03a__03auvm_config_db__Tz28::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtb_rng_uvm_pkg__03a__03auvm_config_db__Tz28::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vtb_rng_uvm_pkg__03a__03auvm_config_db__Tz28::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtb_rng_uvm_pkg__03a__03auvm_config_db__Tz28::to_string_middle\n"); );
    // Body
    std::string out;
    out += Vtb_rng_uvm_pkg__03a__03auvm_resource_db__Tz28::to_string_middle();
    return (out);
}
