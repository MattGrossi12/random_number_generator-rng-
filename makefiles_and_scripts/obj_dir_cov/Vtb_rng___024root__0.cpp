                                                 ...
                                                 (((((IData)(__Vtrigprevexpr_h0ebb1ce0__0) 
                                                  ...
                                                  | ((vlSelfRef.__VdlySched.awaitingCurrentTime() 
                                                     ...
                                                     | ((IData)(vlSymsp->TOP__tb_rng.__PVT__dut__DOT__req_num) 
                                                        != (IData)(vlSelfRef.__Vtrigprevexpr___TOP__tb_rng____PVT__dut__DOT__req_num__1)))));
...
void Vtb_rng___024root___eval_act(Vtb_rng___024root* vlSelf) {
    ...
    if ((3ULL & vlSelfRef.__VactTriggered[3U])) {
        Vtb_rng_tb_rng___act_sequent__TOP__tb_rng__5((&vlSymsp->TOP__tb_rng));
    }
    if ((3ULL & vlSelfRef.__VactTriggered[0U])) {
        Vtb_rng_tb_rng___act_sequent__TOP__tb_rng__6((&vlSymsp->TOP__tb_rng));
    }
}
...
void Vtb_rng___024root___eval_nba(Vtb_rng___024root* vlSelf) {
    ...
    if ((((1ULL & vlSelfRef.__VnbaTriggered[1U]) | 
          (0x000000000000003fULL & vlSelfRef.__VnbaTriggered[2U])) 
         | (3ULL & vlSelfRef.__VnbaTriggered[0U]))) {
        Vtb_rng_tb_rng___act_sequent__TOP__tb_rng__4((&vlSymsp->TOP__tb_rng));
    }
}
