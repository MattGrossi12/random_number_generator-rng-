    ...
    VlQueue<VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_reg_map>> maps;
    {
        ...
        if (__VlefLogAnd_8) {
            ...
            if ((0U != __VlefCall_9__uvm_report_enabled)) {
                ...
                ++(vlSymsp->__Vcoverage[24785]);
            }
            goto __Vlabel0;
        } else {
            ++(vlSymsp->__Vcoverage[24787]);
        }
