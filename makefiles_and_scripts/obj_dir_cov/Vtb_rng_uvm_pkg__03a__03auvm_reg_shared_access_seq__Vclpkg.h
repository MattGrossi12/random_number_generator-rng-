...
#ifndef VERILATED_VTB_RNG_UVM_PKG__03A__03AUVM_REG_SHARED_ACCESS_SEQ__VCLPKG_H_
#define VERILATED_VTB_RNG_UVM_PKG__03A__03AUVM_REG_SHARED_ACCESS_SEQ__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtb_rng_uvm_pkg__03a__03auvm_reg_shared_access_seq__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vtb_rng_uvm_pkg__03a__03auvm_reg_shared_access_seq__Vclpkg();
    ~Vtb_rng_uvm_pkg__03a__03auvm_reg_shared_access_seq__Vclpkg();
    void ctor(Vtb_rng__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vtb_rng_uvm_pkg__03a__03auvm_reg_shared_access_seq__Vclpkg);
    ...
    void __VnoInFunc_get_type(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_object_registry__pi193> &get_type__Vfuncrtn);
...
class Vtb_rng_uvm_pkg__03a__03auvm_reg_shared_access_seq : public Vtb_rng_uvm_pkg__03a__03auvm_reg_sequence__Tz328 {
  public:
    ...
    VlClass* clone() const { return new Vtb_rng_uvm_pkg__03a__03auvm_reg_shared_access_seq(*this); }
  ...
  public:
    Vtb_rng_uvm_pkg__03a__03auvm_reg_shared_access_seq() = default;
    void init(VlProcessRef vlProcess, Vtb_rng__Syms* __restrict vlSymsp, std::string name);
    virtual std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vtb_rng_uvm_pkg__03a__03auvm_reg_shared_access_seq();
};
