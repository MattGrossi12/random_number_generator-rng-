...
void Vtb_rng_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2__Vclpkg::__VnoInFunc_get_type(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_object_registry__Tz265> &get_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtb_rng_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2__Vclpkg::__VnoInFunc_get_type\n"); );
    // Body
    vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__Tz265__Vclpkg.__VnoInFunc_get(vlSymsp, get_type__Vfuncrtn);
    ++(vlSymsp->__Vcoverage[18046]);
}

void Vtb_rng_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc_get_object_type(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_object_wrapper> &get_object_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc_get_object_type\n"); );
    // Locals
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_object_registry__Tz265> __Vfunc_get__0__Vfuncout;
    // Body
    vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__Tz265__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__0__Vfuncout);
    get_object_type__Vfuncrtn = __Vfunc_get__0__Vfuncout;
    ++(vlSymsp->__Vcoverage[18047]);
}

void Vtb_rng_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc_create(VlProcessRef vlProcess, Vtb_rng__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_object> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc_create\n"); );
    // Body
    VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2> tmp;
    if ((""s == name)) {
        tmp = VL_NEW(Vtb_rng_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2, vlProcess, vlSymsp, "unnamed-uvm_simple_lock_dap#(T)"s);
        ++(vlSymsp->__Vcoverage[18048]);
    } else {
        tmp = VL_NEW(Vtb_rng_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2, vlProcess, vlSymsp, name);
...
void Vtb_rng_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::init(VlProcessRef vlProcess, Vtb_rng__Syms* __restrict vlSymsp, std::string name) {
    Vtb_rng_uvm_pkg__03a__03auvm_set_get_dap_base__Tz2::init(vlProcess, vlSymsp, name);
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::new\n"); );
    // Body
...
void Vtb_rng_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc_set(VlProcessRef vlProcess, Vtb_rng__Syms* __restrict vlSymsp, std::string value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc_set\n"); );
    // Locals
    ...
    if (this->__PVT__m_locked) {
        this->__Vfunc_uvm_report_enabled__4__id = "UVM/SIMPLE_LOCK_DAP/SAG"s;
        ...
        if ((0U != __VlefCall_0__uvm_report_enabled)) {
            ...
            __Vtask_uvm_report_error__9__line = 0x00000044U;
            this->__Vtask_uvm_report_error__9__filename = "/home/matheus/tools/1800.2-2017-1.0/src/dap/uvm_simple_lock_dap.svh"s;
            __Vtask_uvm_report_error__9__verbosity = 0U;
            this->__Vtask_uvm_report_error__9__message 
                = VL_SFORMATF_N_NX("Attempt to set new value on '%@', but the data access policy forbids setting while locked!",0,
                                   -1,&(__VlefCall_1__get_full_name)) ;
            this->__Vtask_uvm_report_error__9__id = "UVM/SIMPLE_LOCK_DAP/SAG"s;
...
void Vtb_rng_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc_try_set(Vtb_rng__Syms* __restrict vlSymsp, std::string value, CData/*0:0*/ &try_set__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc_try_set\n"); );
    // Body
    if (this->__PVT__m_locked) {
...
void Vtb_rng_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc_get(Vtb_rng__Syms* __restrict vlSymsp, std::string &get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc_get\n"); );
    // Body
    get__Vfuncrtn = this->__PVT__m_value;
    ++(vlSymsp->__Vcoverage[18060]);
}

void Vtb_rng_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc_try_get(Vtb_rng__Syms* __restrict vlSymsp, std::string &value, CData/*0:0*/ &try_get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc_try_get\n"); );
    // Body
...
void Vtb_rng_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc_lock(Vtb_rng__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc_lock\n"); );
    // Body
    this->__PVT__m_locked = 1U;
    ++(vlSymsp->__Vcoverage[18062]);
}

void Vtb_rng_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc_unlock(Vtb_rng__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc_unlock\n"); );
    // Body
    this->__PVT__m_locked = 0U;
    ++(vlSymsp->__Vcoverage[18063]);
}

void Vtb_rng_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc_is_locked(Vtb_rng__Syms* __restrict vlSymsp, CData/*0:0*/ &is_locked__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc_is_locked\n"); );
    // Body
    is_locked__Vfuncrtn = this->__PVT__m_locked;
    ++(vlSymsp->__Vcoverage[18064]);
}

void Vtb_rng_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc_do_copy(VlProcessRef vlProcess, Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_object> rhs) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc_do_copy\n"); );
    // Locals
    ...
    // Body
    IData/*31:0*/ __VlefCall_0__uvm_report_enabled;
    this->__Vfunc_uvm_report_enabled__14__id = "UVM/SIMPLE_LOCK_DAP/CPY"s;
    ...
    if ((0U != __VlefCall_0__uvm_report_enabled)) {
        ...
        this->__Vtask_uvm_report_error__18__filename = "/home/matheus/tools/1800.2-2017-1.0/src/dap/uvm_simple_lock_dap.svh"s;
        __Vtask_uvm_report_error__18__verbosity = 0U;
        this->__Vtask_uvm_report_error__18__message = "'copy()' is not supported for 'uvm_simple_lock_dap#(T)'"s;
        this->__Vtask_uvm_report_error__18__id = "UVM/SIMPLE_LOCK_DAP/CPY"s;
...
void Vtb_rng_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc_do_pack(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_packer> packer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc_do_pack\n"); );
    // Locals
    ...
    IData/*31:0*/ __VlefCall_0__uvm_report_enabled;
    this->__Vfunc_uvm_report_enabled__22__id = "UVM/SIMPLE_LOCK_DAP/PCK"s;
    ...
    if ((0U != __VlefCall_0__uvm_report_enabled)) {
        ...
        this->__Vtask_uvm_report_error__26__filename = "/home/matheus/tools/1800.2-2017-1.0/src/dap/uvm_simple_lock_dap.svh"s;
        __Vtask_uvm_report_error__26__verbosity = 0U;
        this->__Vtask_uvm_report_error__26__message = "'pack()' is not supported for 'uvm_simple_lock_dap#(T)'"s;
        this->__Vtask_uvm_report_error__26__id = "UVM/SIMPLE_LOCK_DAP/PCK"s;
...
void Vtb_rng_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc_do_unpack(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_packer> packer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc_do_unpack\n"); );
    // Locals
    ...
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    IData/*31:0*/ __VlefCall_0__uvm_report_enabled;
    this->__Vfunc_uvm_report_enabled__30__id = "UVM/SIMPLE_LOCK_DAP/UPK"s;
    ...
    if ((0U != __VlefCall_0__uvm_report_enabled)) {
        ...
        this->__Vtask_uvm_report_error__34__filename = "/home/matheus/tools/1800.2-2017-1.0/src/dap/uvm_simple_lock_dap.svh"s;
        __Vtask_uvm_report_error__34__verbosity = 0U;
        this->__Vtask_uvm_report_error__34__message = "'unpack()' is not supported for 'uvm_simple_lock_dap#(T)'"s;
        this->__Vtask_uvm_report_error__34__id = "UVM/SIMPLE_LOCK_DAP/UPK"s;
...
void Vtb_rng_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc_convert2string(VlProcessRef vlProcess, Vtb_rng__Syms* __restrict vlSymsp, std::string &convert2string__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc_convert2string\n"); );
    // Body
...
void Vtb_rng_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc_do_print(VlProcessRef vlProcess, Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_printer> printer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc_do_print\n"); );
    // Locals
    ...
    VL_NULL_CHECK(printer, "/home/matheus/tools/1800.2-2017-1.0/src/dap/uvm_simple_lock_dap.svh", 170)->__VnoInFunc_print_field(vlProcess, vlSymsp, "lock_state"s, __Vtemp_1, 1U, 0U, 0x2eU, ""s);
    VL_NULL_CHECK(printer, "/home/matheus/tools/1800.2-2017-1.0/src/dap/uvm_simple_lock_dap.svh", 171)->__VnoInFunc_print_generic(vlProcess, vlSymsp, "value"s, "PARAMTYPEDTYPE 'T'"s, 0U, VL_SFORMATF_N_NX("\"%@\"",0,
                                                                                -1,
                                                                                &(this->__PVT__m_value)) , 0x2eU);
    ++(vlSymsp->__Vcoverage[18077]);
}

void Vtb_rng_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc_randomize(Vtb_rng__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc_randomize\n"); );
    // Body
...
void Vtb_rng_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc___Vsetup_constraints(Vtb_rng__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vtb_rng_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc___VBasicRand(Vtb_rng__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::__VnoInFunc___VBasicRand\n"); );
    // Body
    __VBasicRand__Vfuncrtn = 1U;
}

void Vtb_rng_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::_ctor_var_reset(Vtb_rng__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
    __PVT__m_locked = 0;
}

Vtb_rng_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::~Vtb_rng_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::~\n"); );
}

std::string Vtb_rng_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vtb_rng_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_rng_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2::to_string_middle\n"); );
    // Body
    std::string out;
    out += "m_value:" + VL_TO_STRING(__PVT__m_value);
    out += ", m_locked:" + VL_TO_STRING(__PVT__m_locked);
    out += ", " + Vtb_rng_uvm_pkg__03a__03auvm_set_get_dap_base__Tz2::to_string_middle();
    return (out);
}
