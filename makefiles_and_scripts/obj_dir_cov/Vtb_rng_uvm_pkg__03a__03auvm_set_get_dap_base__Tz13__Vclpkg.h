...
#ifndef VERILATED_VTB_RNG_UVM_PKG__03A__03AUVM_SET_GET_DAP_BASE__TZ13__VCLPKG_H_
#define VERILATED_VTB_RNG_UVM_PKG__03A__03AUVM_SET_GET_DAP_BASE__TZ13__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtb_rng_uvm_pkg__03a__03auvm_set_get_dap_base__Tz13__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vtb_rng_uvm_pkg__03a__03auvm_set_get_dap_base__Tz13__Vclpkg();
    ~Vtb_rng_uvm_pkg__03a__03auvm_set_get_dap_base__Tz13__Vclpkg();
    void ctor(Vtb_rng__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vtb_rng_uvm_pkg__03a__03auvm_set_get_dap_base__Tz13__Vclpkg);
...
class Vtb_rng_uvm_pkg__03a__03auvm_set_get_dap_base__Tz13 : public Vtb_rng_uvm_pkg__03a__03auvm_object {
  public:

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_set_get_dap_base__Tz13"; }
  ...
  public:
    Vtb_rng_uvm_pkg__03a__03auvm_set_get_dap_base__Tz13() = default;
    void init(VlProcessRef vlProcess, Vtb_rng__Syms* __restrict vlSymsp, std::string name);
    virtual std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vtb_rng_uvm_pkg__03a__03auvm_set_get_dap_base__Tz13();
};
