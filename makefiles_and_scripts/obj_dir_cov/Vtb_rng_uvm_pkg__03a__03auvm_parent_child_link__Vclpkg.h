...
#ifndef VERILATED_VTB_RNG_UVM_PKG__03A__03AUVM_PARENT_CHILD_LINK__VCLPKG_H_
#define VERILATED_VTB_RNG_UVM_PKG__03A__03AUVM_PARENT_CHILD_LINK__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtb_rng_uvm_pkg__03a__03auvm_parent_child_link__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vtb_rng_uvm_pkg__03a__03auvm_parent_child_link__Vclpkg();
    ~Vtb_rng_uvm_pkg__03a__03auvm_parent_child_link__Vclpkg();
    void ctor(Vtb_rng__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vtb_rng_uvm_pkg__03a__03auvm_parent_child_link__Vclpkg);
    ...
    void __VnoInFunc_get_link(VlProcessRef vlProcess, Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_object> lhs, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_object> rhs, std::string name, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_parent_child_link> &get_link__Vfuncrtn);
    void __VnoInFunc_get_type(Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_uvm_pkg__03a__03auvm_object_registry__pi126> &get_type__Vfuncrtn);
...
class Vtb_rng_uvm_pkg__03a__03auvm_parent_child_link : public Vtb_rng_uvm_pkg__03a__03auvm_link_base {
  public:
    ...
    VlClass* clone() const { return new Vtb_rng_uvm_pkg__03a__03auvm_parent_child_link(*this); }
  ...
  public:
    Vtb_rng_uvm_pkg__03a__03auvm_parent_child_link() = default;
    void init(VlProcessRef vlProcess, Vtb_rng__Syms* __restrict vlSymsp, std::string name);
    virtual std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vtb_rng_uvm_pkg__03a__03auvm_parent_child_link();
};
