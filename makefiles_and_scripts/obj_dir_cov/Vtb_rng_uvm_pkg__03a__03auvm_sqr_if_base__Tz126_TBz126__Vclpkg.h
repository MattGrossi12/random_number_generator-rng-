...
#ifndef VERILATED_VTB_RNG_UVM_PKG__03A__03AUVM_SQR_IF_BASE__TZ126_TBZ126__VCLPKG_H_
#define VERILATED_VTB_RNG_UVM_PKG__03A__03AUVM_SQR_IF_BASE__TZ126_TBZ126__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtb_rng_uvm_pkg__03a__03auvm_sqr_if_base__Tz126_TBz126__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vtb_rng_uvm_pkg__03a__03auvm_sqr_if_base__Tz126_TBz126__Vclpkg();
    ~Vtb_rng_uvm_pkg__03a__03auvm_sqr_if_base__Tz126_TBz126__Vclpkg();
    void ctor(Vtb_rng__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vtb_rng_uvm_pkg__03a__03auvm_sqr_if_base__Tz126_TBz126__Vclpkg);
...
class Vtb_rng_uvm_pkg__03a__03auvm_sqr_if_base__Tz126_TBz126 : public virtual VlClass {
  public:
    ...
    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_sqr_if_base__Tz126_TBz126"; }
    ...
    virtual void __VnoInFunc_item_done(VlProcessRef vlProcess, Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_tb_rng__03a__03arng_seq_item> t);
    ...
    virtual void __VnoInFunc_put_response(VlProcessRef vlProcess, Vtb_rng__Syms* __restrict vlSymsp, VlClassRef<Vtb_rng_tb_rng__03a__03arng_seq_item> t);
  ...
  public:
    Vtb_rng_uvm_pkg__03a__03auvm_sqr_if_base__Tz126_TBz126() = default;
    void init(VlProcessRef vlProcess, Vtb_rng__Syms* __restrict vlSymsp);
    virtual std::string to_string() const;
    std::string to_string_middle() const;
    virtual ~Vtb_rng_uvm_pkg__03a__03auvm_sqr_if_base__Tz126_TBz126();
};
