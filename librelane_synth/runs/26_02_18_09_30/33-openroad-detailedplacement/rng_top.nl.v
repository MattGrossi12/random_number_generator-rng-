module rng_top (clk_i,
 ...
 sky130_fd_sc_hd__a31o_1 _226_ (.A1(\rng_dp.inst.next_num_o[0] ),
    ...
    .B1(_101_),
    .X(_040_));
 sky130_fd_sc_hd__dfrtp_1 _227_ (.CLK(clk_i),
    .D(_003_),
    .RESET_B(net17),
    .Q(\rng_rd.mem[7][0] ));
 sky130_fd_sc_hd__dfrtp_1 _228_ (.CLK(clk_i),
    .D(_004_),
    .RESET_B(net17),
    .Q(\rng_rd.mem[7][1] ));
 sky130_fd_sc_hd__dfrtp_1 _229_ (.CLK(clk_i),
    .D(_005_),
    .RESET_B(net18),
    .Q(\rng_rd.mem[7][2] ));
 sky130_fd_sc_hd__dfrtp_1 _230_ (.CLK(clk_i),
    .D(_006_),
    .RESET_B(net17),
    .Q(\num_i_bar[0] ));
 sky130_fd_sc_hd__dfrtp_4 _231_ (.CLK(clk_i),
    .D(_007_),
    .RESET_B(net17),
    .Q(\num_i_bar[1] ));
 sky130_fd_sc_hd__dfrtp_1 _232_ (.CLK(clk_i),
    .D(_008_),
    .RESET_B(net17),
    .Q(\num_i_bar[2] ));
 sky130_fd_sc_hd__dfrtp_4 _233_ (.CLK(clk_i),
    .D(_001_),
    .RESET_B(net17),
    .Q(\rng_dp.seed_sel_i[0] ));
 sky130_fd_sc_hd__dfrtp_4 _234_ (.CLK(clk_i),
    .D(_002_),
    .RESET_B(net17),
    .Q(\rng_dp.seed_sel_i[1] ));
 sky130_fd_sc_hd__dfrtp_1 _235_ (.CLK(clk_i),
    .D(_009_),
    .RESET_B(net18),
    .Q(\rng_rd.mem[6][0] ));
 sky130_fd_sc_hd__dfrtp_1 _236_ (.CLK(clk_i),
    .D(_010_),
    .RESET_B(net18),
    .Q(\rng_rd.mem[6][1] ));
 sky130_fd_sc_hd__dfrtp_1 _237_ (.CLK(clk_i),
    .D(_011_),
    .RESET_B(net18),
    .Q(\rng_rd.mem[6][2] ));
 sky130_fd_sc_hd__dfrtp_1 _238_ (.CLK(clk_i),
    .D(_012_),
    .RESET_B(net18),
    .Q(\rng_rd.mem[5][0] ));
 sky130_fd_sc_hd__dfrtp_1 _239_ (.CLK(clk_i),
    .D(_013_),
    .RESET_B(net16),
    .Q(\rng_rd.mem[5][1] ));
 sky130_fd_sc_hd__dfrtp_1 _240_ (.CLK(clk_i),
    .D(_014_),
    .RESET_B(net16),
    .Q(\rng_rd.mem[5][2] ));
 sky130_fd_sc_hd__dfrtp_1 _241_ (.CLK(clk_i),
    .D(_015_),
    .RESET_B(net16),
    .Q(\rng_rd.mem[4][0] ));
 sky130_fd_sc_hd__dfrtp_1 _242_ (.CLK(clk_i),
    .D(_016_),
    .RESET_B(net16),
    .Q(\rng_rd.mem[4][1] ));
 sky130_fd_sc_hd__dfrtp_1 _243_ (.CLK(clk_i),
    .D(_017_),
    .RESET_B(net16),
    .Q(\rng_rd.mem[4][2] ));
 sky130_fd_sc_hd__dfrtp_1 _244_ (.CLK(clk_i),
    .D(net3),
    .RESET_B(net14),
    .Q(\rng_rd.wr_ff1 ));
 sky130_fd_sc_hd__dfrtp_1 _245_ (.CLK(clk_i),
    .D(_018_),
    .RESET_B(net14),
    .Q(\rng_rd.mem[3][0] ));
 sky130_fd_sc_hd__dfrtp_1 _246_ (.CLK(clk_i),
    .D(_019_),
    .RESET_B(net16),
    .Q(\rng_rd.mem[3][1] ));
 sky130_fd_sc_hd__dfrtp_1 _247_ (.CLK(clk_i),
    .D(_020_),
    .RESET_B(net16),
    .Q(\rng_rd.mem[3][2] ));
 sky130_fd_sc_hd__dfrtp_1 _248_ (.CLK(clk_i),
    .D(_021_),
    .RESET_B(net15),
    .Q(\rng_rd.mem[2][0] ));
 sky130_fd_sc_hd__dfrtp_1 _249_ (.CLK(clk_i),
    .D(_022_),
    .RESET_B(net15),
    .Q(\rng_rd.mem[2][1] ));
 sky130_fd_sc_hd__dfrtp_1 _250_ (.CLK(clk_i),
    .D(_023_),
    .RESET_B(net16),
    .Q(\rng_rd.mem[2][2] ));
 sky130_fd_sc_hd__dfrtp_1 _251_ (.CLK(clk_i),
    .D(_024_),
    .RESET_B(net15),
    .Q(\rng_rd.mem[1][0] ));
 sky130_fd_sc_hd__dfrtp_1 _252_ (.CLK(clk_i),
    .D(_025_),
    .RESET_B(net14),
    .Q(\rng_rd.mem[1][1] ));
 sky130_fd_sc_hd__dfrtp_1 _253_ (.CLK(clk_i),
    .D(_026_),
    .RESET_B(net14),
    .Q(\rng_rd.mem[1][2] ));
 sky130_fd_sc_hd__dfrtp_1 _254_ (.CLK(clk_i),
    .D(\rng_rd.wr_ff1 ),
    .RESET_B(net14),
    .Q(\rng_rd.wr_ff2 ));
 sky130_fd_sc_hd__dfrtp_1 _255_ (.CLK(clk_i),
    .D(_027_),
    .RESET_B(net15),
    .Q(net4));
 sky130_fd_sc_hd__dfrtp_1 _256_ (.CLK(clk_i),
    .D(_028_),
    .RESET_B(net14),
    .Q(net5));
 sky130_fd_sc_hd__dfrtp_1 _257_ (.CLK(clk_i),
    .D(_029_),
    .RESET_B(net14),
    .Q(net6));
 sky130_fd_sc_hd__dfrtp_1 _258_ (.CLK(clk_i),
    .D(_030_),
    .RESET_B(net14),
    .Q(\rng_rd.vld[0] ));
 sky130_fd_sc_hd__dfrtp_1 _259_ (.CLK(clk_i),
    .D(_031_),
    .RESET_B(net14),
    .Q(\rng_rd.vld[1] ));
 sky130_fd_sc_hd__dfrtp_1 _260_ (.CLK(clk_i),
    .D(_032_),
    .RESET_B(net14),
    .Q(\rng_rd.vld[2] ));
 sky130_fd_sc_hd__dfrtp_1 _261_ (.CLK(clk_i),
    .D(_033_),
    .RESET_B(net16),
    .Q(\rng_rd.vld[3] ));
 sky130_fd_sc_hd__dfrtp_1 _262_ (.CLK(clk_i),
    .D(_034_),
    .RESET_B(net16),
    .Q(\rng_rd.vld[4] ));
 sky130_fd_sc_hd__dfrtp_1 _263_ (.CLK(clk_i),
    .D(_035_),
    .RESET_B(net19),
    .Q(\rng_rd.vld[5] ));
 sky130_fd_sc_hd__dfrtp_1 _264_ (.CLK(clk_i),
    .D(_036_),
    .RESET_B(net18),
    .Q(\rng_rd.vld[6] ));
 sky130_fd_sc_hd__dfrtp_1 _265_ (.CLK(clk_i),
    .D(_037_),
    .RESET_B(net18),
    .Q(\rng_rd.vld[7] ));
 sky130_fd_sc_hd__dfrtp_1 _266_ (.CLK(clk_i),
    .D(\rng_rd.wr_ff2 ),
    .RESET_B(net15),
    .Q(\rng_rd.wr_ff2_d ));
 ...
 sky130_fd_sc_hd__dfrtp_4 _268_ (.CLK(clk_i),
    .D(_039_),
    .RESET_B(net17),
 ...
 sky130_fd_sc_hd__dfrtp_1 _270_ (.CLK(clk_i),
    .D(_000_),
    .RESET_B(net15),
    .Q(\rng_rd.wr_pulse ));
