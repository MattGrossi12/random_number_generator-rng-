module rng_top (clk_i,
 ...
 sky130_fd_sc_hd__and2b_1 _247_ (.A_N(_135_),
    .B(_136_),
    .X(req_num_again));
 sky130_fd_sc_hd__and2b_1 _248_ (.A_N(\rng_rd.wr_ff2_d ),
    .B(\rng_rd.wr_ff2 ),
    .X(_000_));
 ...
 sky130_fd_sc_hd__mux2_1 _306_ (.A0(\rng_rd.mem[1][2] ),
    ...
    .S(net8),
    .X(_032_));
 sky130_fd_sc_hd__mux2_1 _307_ (.A0(net4),
    .A1(\num_i_bar[0] ),
    .S(net7),
    .X(_033_));
 sky130_fd_sc_hd__mux2_1 _308_ (.A0(net5),
    .A1(net18),
    .S(net8),
    .X(_034_));
 sky130_fd_sc_hd__mux2_1 _309_ (.A0(net6),
    ...
    .S(net8),
    .X(_035_));
 sky130_fd_sc_hd__or2_1 _310_ (.A(\rng_rd.vld[0] ),
    .B(net7),
    .X(_036_));
 ...
 sky130_fd_sc_hd__mux2_1 _332_ (.A0(\rng_rd.mem[9][2] ),
    ...
    .S(net9),
    .X(_056_));
 sky130_fd_sc_hd__dfrtp_1 _333_ (.CLK(clk_i),
    .D(_003_),
    .RESET_B(net24),
    .Q(\rng_rd.mem[11][0] ));
 sky130_fd_sc_hd__dfrtp_1 _334_ (.CLK(clk_i),
    .D(_004_),
    .RESET_B(net20),
    .Q(\rng_rd.mem[11][1] ));
 sky130_fd_sc_hd__dfrtp_1 _335_ (.CLK(clk_i),
    .D(_005_),
    .RESET_B(net20),
    .Q(\rng_rd.mem[11][2] ));
 sky130_fd_sc_hd__dfrtp_4 _336_ (.CLK(clk_i),
    .D(_006_),
    .RESET_B(net20),
    .Q(\num_i_bar[0] ));
 sky130_fd_sc_hd__dfrtp_1 _337_ (.CLK(clk_i),
    .D(_007_),
    .RESET_B(net21),
    .Q(\num_i_bar[1] ));
 sky130_fd_sc_hd__dfrtp_1 _338_ (.CLK(clk_i),
    .D(_008_),
    .RESET_B(net20),
    .Q(\num_i_bar[2] ));
 ...
 sky130_fd_sc_hd__dfrtp_1 _341_ (.CLK(clk_i),
    .D(_009_),
    .RESET_B(net25),
    .Q(\rng_rd.mem[7][0] ));
 sky130_fd_sc_hd__dfrtp_1 _342_ (.CLK(clk_i),
    .D(_010_),
    .RESET_B(net25),
    .Q(\rng_rd.mem[7][1] ));
 sky130_fd_sc_hd__dfrtp_1 _343_ (.CLK(clk_i),
    .D(_011_),
    .RESET_B(net25),
    .Q(\rng_rd.mem[7][2] ));
 sky130_fd_sc_hd__dfrtp_1 _344_ (.CLK(clk_i),
    .D(_012_),
    .RESET_B(net24),
    .Q(\rng_rd.mem[10][0] ));
 sky130_fd_sc_hd__dfrtp_1 _345_ (.CLK(clk_i),
    .D(_013_),
    .RESET_B(net24),
    .Q(\rng_rd.mem[10][1] ));
 sky130_fd_sc_hd__dfrtp_1 _346_ (.CLK(clk_i),
    .D(_014_),
    .RESET_B(net24),
    .Q(\rng_rd.mem[10][2] ));
 sky130_fd_sc_hd__dfrtp_1 _347_ (.CLK(clk_i),
    .D(_015_),
    .RESET_B(net25),
    .Q(\rng_rd.mem[6][0] ));
 sky130_fd_sc_hd__dfrtp_1 _348_ (.CLK(clk_i),
    .D(_016_),
    .RESET_B(net26),
    .Q(\rng_rd.mem[6][1] ));
 sky130_fd_sc_hd__dfrtp_1 _349_ (.CLK(clk_i),
    .D(_017_),
    .RESET_B(net25),
    .Q(\rng_rd.mem[6][2] ));
 sky130_fd_sc_hd__dfrtp_1 _350_ (.CLK(clk_i),
    .D(_018_),
    .RESET_B(net25),
    .Q(\rng_rd.mem[5][0] ));
 sky130_fd_sc_hd__dfrtp_1 _351_ (.CLK(clk_i),
    .D(_019_),
    .RESET_B(net25),
    .Q(\rng_rd.mem[5][1] ));
 sky130_fd_sc_hd__dfrtp_1 _352_ (.CLK(clk_i),
    .D(_020_),
    .RESET_B(net25),
    .Q(\rng_rd.mem[5][2] ));
 sky130_fd_sc_hd__dfrtp_1 _353_ (.CLK(clk_i),
    .D(_021_),
    .RESET_B(net22),
    .Q(\rng_rd.mem[4][0] ));
 sky130_fd_sc_hd__dfrtp_1 _354_ (.CLK(clk_i),
    .D(_022_),
    .RESET_B(net22),
    .Q(\rng_rd.mem[4][1] ));
 sky130_fd_sc_hd__dfrtp_1 _355_ (.CLK(clk_i),
    .D(_023_),
    .RESET_B(net23),
    .Q(\rng_rd.mem[4][2] ));
 sky130_fd_sc_hd__dfrtp_1 _356_ (.CLK(clk_i),
    .D(net3),
    .RESET_B(net20),
    .Q(\rng_rd.wr_ff1 ));
 sky130_fd_sc_hd__dfrtp_1 _357_ (.CLK(clk_i),
    .D(_024_),
    .RESET_B(net23),
    .Q(\rng_rd.mem[3][0] ));
 sky130_fd_sc_hd__dfrtp_1 _358_ (.CLK(clk_i),
    .D(_025_),
    .RESET_B(net23),
    .Q(\rng_rd.mem[3][1] ));
 sky130_fd_sc_hd__dfrtp_1 _359_ (.CLK(clk_i),
    .D(_026_),
    .RESET_B(net23),
    .Q(\rng_rd.mem[3][2] ));
 sky130_fd_sc_hd__dfrtp_1 _360_ (.CLK(clk_i),
    .D(_027_),
    .RESET_B(net23),
    .Q(\rng_rd.mem[2][0] ));
 sky130_fd_sc_hd__dfrtp_1 _361_ (.CLK(clk_i),
    .D(_028_),
    .RESET_B(net22),
    .Q(\rng_rd.mem[2][1] ));
 sky130_fd_sc_hd__dfrtp_1 _362_ (.CLK(clk_i),
    .D(_029_),
    .RESET_B(net21),
    .Q(\rng_rd.mem[2][2] ));
 sky130_fd_sc_hd__dfrtp_1 _363_ (.CLK(clk_i),
    .D(_030_),
    .RESET_B(net22),
    .Q(\rng_rd.mem[1][0] ));
 sky130_fd_sc_hd__dfrtp_1 _364_ (.CLK(clk_i),
    .D(_031_),
    .RESET_B(net22),
    .Q(\rng_rd.mem[1][1] ));
 sky130_fd_sc_hd__dfrtp_1 _365_ (.CLK(clk_i),
    .D(_032_),
    .RESET_B(net20),
    .Q(\rng_rd.mem[1][2] ));
 sky130_fd_sc_hd__dfrtp_1 _366_ (.CLK(clk_i),
    .D(\rng_rd.wr_ff1 ),
    .RESET_B(net20),
    .Q(\rng_rd.wr_ff2 ));
 sky130_fd_sc_hd__dfrtp_1 _367_ (.CLK(clk_i),
    .D(_033_),
    .RESET_B(net22),
    .Q(net4));
 sky130_fd_sc_hd__dfrtp_1 _368_ (.CLK(clk_i),
    .D(_034_),
    .RESET_B(net22),
    .Q(net5));
 sky130_fd_sc_hd__dfrtp_1 _369_ (.CLK(clk_i),
    .D(_035_),
    .RESET_B(net20),
    .Q(net6));
 sky130_fd_sc_hd__dfrtp_1 _370_ (.CLK(clk_i),
    .D(_036_),
    .RESET_B(net22),
    .Q(\rng_rd.vld[0] ));
 sky130_fd_sc_hd__dfrtp_1 _371_ (.CLK(clk_i),
    .D(_037_),
    .RESET_B(net22),
    .Q(\rng_rd.vld[1] ));
 sky130_fd_sc_hd__dfrtp_1 _372_ (.CLK(clk_i),
    .D(_038_),
    .RESET_B(net22),
    .Q(\rng_rd.vld[2] ));
 sky130_fd_sc_hd__dfrtp_1 _373_ (.CLK(clk_i),
    .D(_039_),
    .RESET_B(net23),
    .Q(\rng_rd.vld[3] ));
 sky130_fd_sc_hd__dfrtp_1 _374_ (.CLK(clk_i),
    .D(_040_),
    .RESET_B(net23),
    .Q(\rng_rd.vld[4] ));
 sky130_fd_sc_hd__dfrtp_1 _375_ (.CLK(clk_i),
    .D(_041_),
    .RESET_B(net25),
    .Q(\rng_rd.vld[5] ));
 sky130_fd_sc_hd__dfrtp_1 _376_ (.CLK(clk_i),
    .D(_042_),
    .RESET_B(net25),
    .Q(\rng_rd.vld[6] ));
 sky130_fd_sc_hd__dfrtp_1 _377_ (.CLK(clk_i),
    .D(_043_),
    .RESET_B(net26),
    .Q(\rng_rd.vld[7] ));
 sky130_fd_sc_hd__dfrtp_1 _378_ (.CLK(clk_i),
    .D(_044_),
    .RESET_B(net24),
    .Q(\rng_rd.vld[8] ));
 sky130_fd_sc_hd__dfrtp_1 _379_ (.CLK(clk_i),
    .D(_045_),
    .RESET_B(net24),
    .Q(\rng_rd.vld[9] ));
 sky130_fd_sc_hd__dfrtp_1 _380_ (.CLK(clk_i),
    .D(_046_),
    .RESET_B(net24),
    .Q(\rng_rd.vld[10] ));
 sky130_fd_sc_hd__dfrtp_1 _381_ (.CLK(clk_i),
    .D(_047_),
    .RESET_B(net24),
    .Q(\rng_rd.vld[11] ));
 sky130_fd_sc_hd__dfrtp_1 _382_ (.CLK(clk_i),
    .D(_048_),
    .RESET_B(net26),
    .Q(\rng_rd.mem[8][0] ));
 sky130_fd_sc_hd__dfrtp_1 _383_ (.CLK(clk_i),
    .D(_049_),
    .RESET_B(net26),
    .Q(\rng_rd.mem[8][1] ));
 sky130_fd_sc_hd__dfrtp_1 _384_ (.CLK(clk_i),
    .D(_050_),
    .RESET_B(net24),
    .Q(\rng_rd.mem[8][2] ));
 sky130_fd_sc_hd__dfrtp_1 _385_ (.CLK(clk_i),
    .D(\rng_rd.wr_ff2 ),
    .RESET_B(net21),
    .Q(\rng_rd.wr_ff2_d ));
 sky130_fd_sc_hd__dfrtp_4 _386_ (.CLK(clk_i),
    .D(_051_),
    .RESET_B(net21),
    .Q(\rng_dp.inst.next_num_o[0] ));
 sky130_fd_sc_hd__dfrtp_4 _387_ (.CLK(clk_i),
    .D(_052_),
    .RESET_B(net21),
 ...
 sky130_fd_sc_hd__dfrtp_1 _389_ (.CLK(clk_i),
    .D(_054_),
    .RESET_B(net24),
    .Q(\rng_rd.mem[9][0] ));
 sky130_fd_sc_hd__dfrtp_1 _390_ (.CLK(clk_i),
    .D(_055_),
    .RESET_B(net26),
    .Q(\rng_rd.mem[9][1] ));
 sky130_fd_sc_hd__dfrtp_1 _391_ (.CLK(clk_i),
    .D(_056_),
    .RESET_B(net26),
    .Q(\rng_rd.mem[9][2] ));
 sky130_fd_sc_hd__dfrtp_1 _392_ (.CLK(clk_i),
    .D(_000_),
    .RESET_B(net21),
    .Q(\rng_rd.wr_pulse ));
