module rng_top (clk_i,
 ...
 sky130_fd_sc_hd__mux2_1 _158_ (.A0(\rng_rd.ram_6[2] ),
    ...
    .VPWR(VPWR),
    .X(_031_));
 sky130_fd_sc_hd__dfrtp_1 _159_ (.CLK(clk_i),
    .D(_002_),
    .RESET_B(net14),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\rng_rd.cache[0] ));
 sky130_fd_sc_hd__dfrtp_1 _160_ (.CLK(clk_i),
    .D(_003_),
    .RESET_B(net14),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\rng_rd.cache[1] ));
 sky130_fd_sc_hd__dfrtp_1 _161_ (.CLK(clk_i),
    .D(_004_),
    .RESET_B(net14),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _163_ (.CLK(clk_i),
    ...
    .VPWR(VPWR),
    .Q(\rng_rd.ram_7[1] ));
 sky130_fd_sc_hd__dfrtp_1 _164_ (.CLK(clk_i),
    .D(_007_),
    .RESET_B(net15),
    .VGND(VGND),
    .VNB(VGND),
